...
_RAWOUTPUTDATACONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='raw_output_data_prefix', full_name='flyteidl.admin.RawOutputDataConfig.raw_output_data_prefix', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAUNCHPLANSPEC.fields_by_name['raw_output_data_config'].message_type = _RAWOUTPUTDATACONFIG
