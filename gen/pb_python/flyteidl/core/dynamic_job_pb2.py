...
_DYNAMICJOBSPEC.fields_by_name['nodes'].message_type = flyteidl_dot_core_dot_literals__pb2._NODE
...
_DYNAMICJOBSPEC.fields_by_name['subworkflows'].message_type = flyteidl_dot_core_dot_literals__pb2._WORKFLOWTEMPLATE
