...
type UnionType struct {
	...
	Values               []*LiteralType `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *UnionType) GetValues() []*LiteralType {
	if m != nil {
		return m.Values
	}
	return nil
...
var fileDescriptor_51e8add38f4caaed = []byte{
	...
	,
}
