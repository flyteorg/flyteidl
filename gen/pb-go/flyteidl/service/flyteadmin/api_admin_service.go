...
/* 
AdminServiceApiService Retrieve a :ref:&#x60;ref_flyteidl.admin.Project&#x60; with the Flyte deployment.
Retrieve a project.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
...
*/
func (a *AdminServiceApiService) GetProject(ctx context.Context, id string) (AdminProjectRegisterResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
