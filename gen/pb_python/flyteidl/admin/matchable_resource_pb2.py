...
_LISTMATCHABLERESOURCESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_type', full_name='flyteidl.admin.ListMatchableResourcesRequest.resource_type', index=0,
