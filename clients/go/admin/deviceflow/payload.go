...
type DeviceAuthorizationRequest struct {
	// ClientID The client identifier issued to the client during the registration process of OAuth app with the authorization server
...
type DeviceAuthorizationResponse struct {
	...
	// Interval minimum amount of time the client app should wait between polling requests to the token endpoint.
