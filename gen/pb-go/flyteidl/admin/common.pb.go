...
// NamedEntityIdentifier from public import flyteidl/core/named_entity_identifier.proto
type NamedEntityIdentifier = core.NamedEntityIdentifier
...
func (Sort_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7c2cf612a185829c, []int{2, 0}
}
...
type NamedEntity struct {
	...
	Id                   *core.NamedEntityIdentifier `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
...
func (m *NamedEntity) GetId() *core.NamedEntityIdentifier {
	if m != nil {
		return m.Id
	}
	return nil
...
type NamedEntityIdentifierList struct {
	...
	Entities []*core.NamedEntityIdentifier `protobuf:"bytes,1,rep,name=entities,proto3" json:"entities,omitempty"`
	// In the case of multiple pages of results, the server-provided token can be used to fetch the next page
...
func (m *NamedEntityIdentifierList) GetEntities() []*core.NamedEntityIdentifier {
	if m != nil {
		return m.Entities
	}
	return nil
...
func (m *NamedEntityGetRequest) GetId() *core.NamedEntityIdentifier {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *NamedEntityUpdateRequest) GetId() *core.NamedEntityIdentifier {
	if m != nil {
		return m.Id
	}
	return nil
...
type ResourceListRequest struct {
	...
	Id *core.NamedEntityIdentifier `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// Indicates the number of resources to be returned.
...
func (m *ResourceListRequest) GetId() *core.NamedEntityIdentifier {
	if m != nil {
		return m.Id
	}
	return nil
...
var fileDescriptor_7c2cf612a185829c = []byte{
	...
	,
}
