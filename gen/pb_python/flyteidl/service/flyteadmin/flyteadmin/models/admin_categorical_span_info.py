...
from flyteadmin.models.categorical_span_info_category import CategoricalSpanInfoCategory  # noqa: F401,E501


class AdminCategoricalSpanInfo(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AdminCategoricalSpanInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdminCategoricalSpanInfo):
            return False
