...
type Config struct {
	...
	Audience                string          `json:"audience" pflag:",audience value to be passed when requesting access token.Required when auth server hasn't been configured with default audience"`
}
