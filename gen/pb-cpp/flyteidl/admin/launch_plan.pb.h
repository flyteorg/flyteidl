...
class LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse;
class LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUseDefaultTypeInternal;
extern LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUseDefaultTypeInternal _LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse_default_instance_;
...
template<> ::flyteidl::admin::LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse* Arena::CreateMaybeMessage<::flyteidl::admin::LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse>(Arena*);
...
class LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse : public ::google::protobuf::internal::MapEntry<LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse, 
...
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
  typedef ::google::protobuf::internal::MapEntry<LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse, 
    ::std::string, ::flyteidl::core::TaskNodeOverrides,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
    0 > SuperType;
  LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse();
  LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse(::google::protobuf::Arena* arena);
  void MergeFrom(const LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse& other);
  static const LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse*>(&_LaunchPlanSpec_TaskNodeRuntimeOverridesEntry_DoNotUse_default_instance_); }
...
class LaunchPlanSpec final :
 ...
 public:
  ...
  static const int kTaskNodeRuntimeOverridesFieldNumber = 22;
...
// map<string, .flyteidl.core.TaskNodeOverrides> task_node_runtime_overrides = 22;
inline int LaunchPlanSpec::task_node_runtime_overrides_size() const {
  return task_node_runtime_overrides_.size();
}
inline const ::google::protobuf::Map< ::std::string, ::flyteidl::core::TaskNodeOverrides >&
LaunchPlanSpec::task_node_runtime_overrides() const {
  // @@protoc_insertion_point(field_map:flyteidl.admin.LaunchPlanSpec.task_node_runtime_overrides)
  return task_node_runtime_overrides_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::flyteidl::core::TaskNodeOverrides >*
LaunchPlanSpec::mutable_task_node_runtime_overrides() {
  // @@protoc_insertion_point(field_mutable_map:flyteidl.admin.LaunchPlanSpec.task_node_runtime_overrides)
