...
_LAUNCHPLANCREATEREQUEST.fields_by_name['id'].message_type = admin_dot_common__pb2._IDENTIFIER
_LAUNCHPLANCREATEREQUEST.fields_by_name['spec'].message_type = _LAUNCHPLANSPEC
_LAUNCHPLAN.fields_by_name['id'].message_type = admin_dot_common__pb2._IDENTIFIER
...
_LAUNCHPLANSPEC.fields_by_name['default_inputs'].message_type = admin_dot_common__pb2._PARAMETER
_LAUNCHPLANSPEC.fields_by_name['fixed_inputs'].message_type = core_dot_interface__pb2._NAMEDVALUECOLLECTION
_LAUNCHPLANMETADATA.fields_by_name['schedule'].message_type = admin_dot_schedule__pb2._SCHEDULE
_LAUNCHPLANMETADATA.fields_by_name['notifications'].message_type = admin_dot_common__pb2._NOTIFICATION
...
LaunchPlanCreateRequest = _reflection.GeneratedProtocolMessageType('LaunchPlanCreateRequest', (_message.Message,), dict(
  ...
  __module__ = 'admin.launch_plan_pb2'
