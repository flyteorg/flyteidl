...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002O\032J/api/v1/project_domain_attributes/{attributes.project}/{attributes.domain}:\001*\222AX\032VUpdate the customized resource attributes associated with a project-domain combination')),
  ),
])
