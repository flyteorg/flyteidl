...
type LaunchPlanSpec struct {
	...
	TaskNodeRuntimeOverrides map[string]*core.TaskNodeOverrides `protobuf:"bytes,22,rep,name=task_node_runtime_overrides,json=taskNodeRuntimeOverrides,proto3" json:"task_node_runtime_overrides,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral     struct{}                           `json:"-"`
	XXX_unrecognized         []byte                             `json:"-"`
	XXX_sizecache            int32                              `json:"-"`
}
...
func (m *LaunchPlanSpec) GetTaskNodeRuntimeOverrides() map[string]*core.TaskNodeOverrides {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*core.TaskNodeOverrides)(nil), "flyteidl.admin.LaunchPlanSpec.TaskNodeRuntimeOverridesEntry")
...
var fileDescriptor_368a863574f5e699 = []byte{
	...
	,
}
