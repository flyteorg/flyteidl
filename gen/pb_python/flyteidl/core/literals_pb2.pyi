...
class Literal(_message.Message):
    __slots__ = ["scalar", "collection", "map", "hash", "metadata", "literal_type"]
    ...
    literal_type: _types_pb2.LiteralType
    def __init__(self, scalar: _Optional[_Union[Scalar, _Mapping]] = ..., collection: _Optional[_Union[LiteralCollection, _Mapping]] = ..., map: _Optional[_Union[LiteralMap, _Mapping]] = ..., hash: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ..., literal_type: _Optional[_Union[_types_pb2.LiteralType, _Mapping]] = ...) -> None: ...
