...
type RawOutputDataConfig struct {
	...
	RawOutputDataPrefix  string   `protobuf:"bytes,1,opt,name=raw_output_data_prefix,json=rawOutputDataPrefix,proto3" json:"raw_output_data_prefix,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RawOutputDataConfig) GetRawOutputDataPrefix() string {
	if m != nil {
		return m.RawOutputDataPrefix
	}
	return ""
}
...
var fileDescriptor_368a863574f5e699 = []byte{
	...
	,
}
