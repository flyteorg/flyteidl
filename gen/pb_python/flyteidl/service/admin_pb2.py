...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetNodeEvent',
    full_name='flyteidl.service.AdminService.GetNodeEvent',
    index=18,
    containing_service=None,
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002*\022(/api/v1/events/nodes/{node_execution_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='ListNodeEvents',
    full_name='flyteidl.service.AdminService.ListNodeEvents',
    index=19,
    containing_service=None,
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\026\022\024/api/v1/events/nodes')),
  ),
  _descriptor.MethodDescriptor(
