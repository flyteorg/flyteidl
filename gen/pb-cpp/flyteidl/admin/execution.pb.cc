...
const ::google::protobuf::uint32 TableStruct_flyteidl_2fadmin_2fexecution_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::ExecutionRelaunchRequest, skip_cache_),
  ~0u,  // no _has_bits_
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fadmin_2fexecution_2eproto = {
  ...
  "flyteidl/admin/execution.proto", &assign_descriptors_table_flyteidl_2fadmin_2fexecution_2eproto, 4325,
};
...
const int ExecutionRelaunchRequest::kSkipCacheFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
void ExecutionRelaunchRequest::SharedCtor() {
  ...
  ::memset(&id_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&id_)) + sizeof(skip_cache_));
}
...
void ExecutionRelaunchRequest::SerializeWithCachedSizes(
  ...
  if (this->skip_cache() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(4, this->skip_cache(), output);
  }
...
::google::protobuf::uint8* ExecutionRelaunchRequest::InternalSerializeWithCachedSizesToArray(
  ...
  // bool skip_cache = 4;
  if (this->skip_cache() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(4, this->skip_cache(), target);
  }
