...
type NodeExecutionRecoverResponse struct {
	// Computed results associated with the recovered node execution.
	Closure *NodeExecutionClosure `protobuf:"bytes,1,opt,name=closure,proto3" json:"closure,omitempty"`
	// Any data produced by the original node execution.
	Data                 *NodeExecutionGetDataResponse `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}

func (m *NodeExecutionRecoverResponse) Reset()         { *m = NodeExecutionRecoverResponse{} }
func (m *NodeExecutionRecoverResponse) String() string { return proto.CompactTextString(m) }
func (*NodeExecutionRecoverResponse) ProtoMessage()    {}
func (*NodeExecutionRecoverResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f73b3eae493fd736, []int{13}
}

func (m *NodeExecutionRecoverResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NodeExecutionRecoverResponse.Unmarshal(m, b)
}
func (m *NodeExecutionRecoverResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NodeExecutionRecoverResponse.Marshal(b, m, deterministic)
}
func (m *NodeExecutionRecoverResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeExecutionRecoverResponse.Merge(m, src)
}
func (m *NodeExecutionRecoverResponse) XXX_Size() int {
	return xxx_messageInfo_NodeExecutionRecoverResponse.Size(m)
}
func (m *NodeExecutionRecoverResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_NodeExecutionRecoverResponse.DiscardUnknown(m)
}

var xxx_messageInfo_NodeExecutionRecoverResponse proto.InternalMessageInfo

func (m *NodeExecutionRecoverResponse) GetClosure() *NodeExecutionClosure {
	if m != nil {
		return m.Closure
	}
	return nil
...
func (m *NodeExecutionRecoverResponse) GetData() *NodeExecutionGetDataResponse {
	if m != nil {
		return m.Data
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*NodeExecutionRecoverResponse)(nil), "flyteidl.admin.NodeExecutionRecoverResponse")
}
...
var fileDescriptor_f73b3eae493fd736 = []byte{
	...
	,
}
