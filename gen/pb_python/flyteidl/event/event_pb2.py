...
_TASKEXECUTIONMETADATA_INSTANCETYPE = _descriptor.EnumDescriptor(
  name='InstanceType',
  full_name='flyteidl.event.TaskExecutionMetadata.InstanceType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_TASKEXECUTIONMETADATA_INSTANCETYPE)
...
_TASKEXECUTIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='instance_type', full_name='flyteidl.event.TaskExecutionMetadata.instance_type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _TASKEXECUTIONMETADATA_INSTANCETYPE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_TASKEXECUTIONMETADATA.fields_by_name['instance_type'].enum_type = _TASKEXECUTIONMETADATA_INSTANCETYPE
_TASKEXECUTIONMETADATA_INSTANCETYPE.containing_type = _TASKEXECUTIONMETADATA
