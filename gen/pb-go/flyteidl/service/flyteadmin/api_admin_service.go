...
/* 
AdminServiceApiService Create a :ref:&#x60;ref_flyteidl.admin.DescriptionEntity&#x60; object.
Create and register a description entity definition.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body

@return AdminDescriptionEntityCreateResponse
*/
func (a *AdminServiceApiService) CreateDescriptionEntity(ctx context.Context, body AdminDescriptionEntityCreateRequest) (AdminDescriptionEntityCreateResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AdminDescriptionEntityCreateResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdminDescriptionEntityCreateResponse
