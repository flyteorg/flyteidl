...
_TASKEXECUTIONCLOSURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deck_uri', full_name='flyteidl.admin.TaskExecutionClosure.deck_uri', index=14,
