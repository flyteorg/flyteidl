...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\037\"\032/api/v1/description_entity:\001*\222A\341\001\0324Create and register a description entity definition.JB\n\003400\022;\n9Returned for bad request that may have failed validation.Je\n\003409\022^\n\\Returned for a request that references an identical entity that has already been registered.'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002L\022J/api/v1/description_entity/{id.project}/{id.domain}/{id.name}/{id.version}\222A*\032(Retrieve an existing entity description.'),
  ),
])
