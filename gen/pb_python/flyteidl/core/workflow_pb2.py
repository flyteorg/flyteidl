...
_NODEMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_wait_time', full_name='flyteidl.core.NodeMetadata.max_wait_time', index=4,
...
_WORKFLOWMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='max_wait_time', full_name='flyteidl.core.WorkflowMetadata.max_wait_time', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NODEMETADATA.fields_by_name['max_wait_time'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
...
_WORKFLOWMETADATA.fields_by_name['max_wait_time'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
