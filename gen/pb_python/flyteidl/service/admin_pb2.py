...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002p\022n/api/v1/node_executions/{id.execution_id.project}/{id.execution_id.domain}/{id.execution_id.name}/{id.node_id}\222Ac\032aRetrieve an existing node execution. See :ref:`ref_flyteidl.admin.NodeExecution` for more details'),
  ),
  _descriptor.MethodDescriptor(
