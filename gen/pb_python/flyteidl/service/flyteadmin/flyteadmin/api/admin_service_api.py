...
class AdminServiceApi(object):
    ...
    def create_description_entity(self, body, **kwargs):  # noqa: E501
        """Create a :ref:`ref_flyteidl.admin.DescriptionEntity` object.  # noqa: E501

        Create and register a description entity definition.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_description_entity(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AdminDescriptionEntityCreateRequest body: (required)
        :return: AdminDescriptionEntityCreateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_description_entity_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_description_entity_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_description_entity_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a :ref:`ref_flyteidl.admin.DescriptionEntity` object.  # noqa: E501

        Create and register a description entity definition.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_description_entity_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_description_entity" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_description_entity`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='AdminDescriptionEntityCreateResponse',  # noqa: E501
