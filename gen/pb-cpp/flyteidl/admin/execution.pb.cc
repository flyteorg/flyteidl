...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fadmin_2fexecution_2eproto = {
  ...
  "flyteidl/admin/execution.proto", &assign_descriptors_table_flyteidl_2fadmin_2fexecution_2eproto, 4219,
};
...
void ExecutionSpec::SerializeWithCachedSizes(
  ...
  if (this->interruptible() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(21, this->interruptible(), output);
  }
...
::google::protobuf::uint8* ExecutionSpec::InternalSerializeWithCachedSizesToArray(
  ...
  // bool interruptible = 21;
  if (this->interruptible() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(21, this->interruptible(), target);
  }
