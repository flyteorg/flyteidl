...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002e\032`/api/v1/project_domain_attributes/{attributes.project}/{attributes.domain}/{attributes.workflow}:\001*\222Af\032dUpdate the customized resource attributes associated with a project, domain and workflow combination'),
  ),
  _descriptor.MethodDescriptor(
