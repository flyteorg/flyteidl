...
_TASKNODEOVERRIDES_CONFIGENTRY = _descriptor.Descriptor(
  name='ConfigEntry',
  full_name='flyteidl.core.TaskNodeOverrides.ConfigEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flyteidl.core.TaskNodeOverrides.ConfigEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='flyteidl.core.TaskNodeOverrides.ConfigEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TASKNODEOVERRIDES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='env', full_name='flyteidl.core.TaskNodeOverrides.env', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='security_context', full_name='flyteidl.core.TaskNodeOverrides.security_context', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='config', full_name='flyteidl.core.TaskNodeOverrides.config', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_TASKNODEOVERRIDES_CONFIGENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TASKNODEOVERRIDES_CONFIGENTRY.containing_type = _TASKNODEOVERRIDES
_TASKNODEOVERRIDES.fields_by_name['resources'].message_type = flyteidl_dot_core_dot_tasks__pb2._RESOURCES
_TASKNODEOVERRIDES.fields_by_name['env'].message_type = flyteidl_dot_core_dot_literals__pb2._KEYVALUEPAIR
_TASKNODEOVERRIDES.fields_by_name['security_context'].message_type = flyteidl_dot_core_dot_security__pb2._SECURITYCONTEXT
_TASKNODEOVERRIDES.fields_by_name['config'].message_type = _TASKNODEOVERRIDES_CONFIGENTRY
...
TaskNodeOverrides = _reflection.GeneratedProtocolMessageType('TaskNodeOverrides', (_message.Message,), dict(
  ...
  ConfigEntry = _reflection.GeneratedProtocolMessageType('ConfigEntry', (_message.Message,), dict(
    DESCRIPTOR = _TASKNODEOVERRIDES_CONFIGENTRY,
    __module__ = 'flyteidl.core.workflow_pb2'
    # @@protoc_insertion_point(class_scope:flyteidl.core.TaskNodeOverrides.ConfigEntry)
    ))
  ,
...
_sym_db.RegisterMessage(TaskNodeOverrides.ConfigEntry)


DESCRIPTOR._options = None
_TASKNODEOVERRIDES_CONFIGENTRY._options = None
