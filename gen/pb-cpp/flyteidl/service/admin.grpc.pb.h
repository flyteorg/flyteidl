 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::flyteidl::admin::DataResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::DataResponse>> AsyncGetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::DataResponse>>(AsyncGetDataRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::DataResponse>> PrepareAsyncGetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::DataResponse>>(PrepareAsyncGetDataRaw(context, request, cq));
    }
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::DataResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      virtual void GetData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Registers a :ref:`ref_flyteidl.admin.Project` with the Flyte deployment.
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::DataResponse>* AsyncGetDataRaw(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::DataResponse>* PrepareAsyncGetDataRaw(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::flyteidl::admin::DataResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>> AsyncGetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>>(AsyncGetDataRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>> PrepareAsyncGetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>>(PrepareAsyncGetDataRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      ...
      void GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response, std::function<void(::grpc::Status)>) override;
      void GetData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::DataResponse* response, std::function<void(::grpc::Status)>) override;
      void GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      void GetData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>* AsyncGetDataRaw(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>* PrepareAsyncGetDataRaw(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status GetData(::grpc::ServerContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response);
    // Registers a :ref:`ref_flyteidl.admin.Project` with the Flyte deployment.
  ...
  class WithAsyncMethod_GetData : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetData(::grpc::ServerContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetData(::grpc::ServerContext* context, ::flyteidl::admin::FlyteArtifactGetRequest* request, ::grpc::ServerAsyncResponseWriter< ::flyteidl::admin::DataResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    ExperimentalWithCallbackMethod_GetData() {
      ::grpc::Service::experimental().MarkMethodCallback(27,
        new ::grpc::internal::CallbackUnaryHandler< ::flyteidl::admin::FlyteArtifactGetRequest, ::flyteidl::admin::DataResponse>(
          [this](::grpc::ServerContext* context,
                 const ::flyteidl::admin::FlyteArtifactGetRequest* request,
    ...
    void SetMessageAllocatorFor_GetData(
        ::grpc::experimental::MessageAllocator< ::flyteidl::admin::FlyteArtifactGetRequest, ::flyteidl::admin::DataResponse>* allocator) {
      static_cast<::grpc::internal::CallbackUnaryHandler< ::flyteidl::admin::FlyteArtifactGetRequest, ::flyteidl::admin::DataResponse>*>(
    ...
    virtual void GetData(::grpc::ServerContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_GetData() {
      ::grpc::Service::MarkMethodStreamed(27,
        new ::grpc::internal::StreamedUnaryHandler< ::flyteidl::admin::FlyteArtifactGetRequest, ::flyteidl::admin::DataResponse>(std::bind(&WithStreamedUnaryMethod_GetData<BaseClass>::StreamedGetData, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetData(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::flyteidl::admin::FlyteArtifactGetRequest,::flyteidl::admin::DataResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
