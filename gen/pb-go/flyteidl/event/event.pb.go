...
type NodeExecutionEvent struct {
	...
	IsParent bool `protobuf:"varint,16,opt,name=is_parent,json=isParent,proto3" json:"is_parent,omitempty"`
	// Whether this node yielded a dynamic workflow.
	IsDynamic            bool     `protobuf:"varint,17,opt,name=is_dynamic,json=isDynamic,proto3" json:"is_dynamic,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_4b035d24120b1b12 = []byte{
	...
	,
}
