...
_EXPANDEDSCHEMATYPE = _descriptor.Descriptor(
  name='ExpandedSchemaType',
  full_name='flyteidl.core.ExpandedSchemaType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='columns', full_name='flyteidl.core.ExpandedSchemaType.columns', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='names', full_name='flyteidl.core.ExpandedSchemaType.names', index=1,
...
_EXPANDEDSCHEMATYPE.fields_by_name['columns'].message_type = _LITERALTYPE
...
DESCRIPTOR.message_types_by_name['ExpandedSchemaType'] = _EXPANDEDSCHEMATYPE
...
ExpandedSchemaType = _reflection.GeneratedProtocolMessageType('ExpandedSchemaType', (_message.Message,), dict(
  DESCRIPTOR = _EXPANDEDSCHEMATYPE,
  __module__ = 'flyteidl.core.types_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.ExpandedSchemaType)
  ))
_sym_db.RegisterMessage(ExpandedSchemaType)
