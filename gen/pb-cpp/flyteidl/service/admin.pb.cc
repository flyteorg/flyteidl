...
const char descriptor_table_protodef_flyteidl_2fservice_2fadmin_2eproto[] =
  ...
  "admin.NamedEntityList\"\241\001\202\323\344\223\002;\0229/api/v1/"
  "named_entities/{resource_type}/{project}"
  "/{domain}\222A]\032[Retrieve a list of NamedEn"
  "tity objects sharing a common resource t"
  "ype, project, and domain.\022\312\001\n\016GetNamedEn"
  "tity\022%.flyteidl.admin.NamedEntityGetRequ"
  "est\032\033.flyteidl.admin.NamedEntity\"t\202\323\344\223\002K"
  "\022I/api/v1/named_entities/{resource_type}"
  "/{id.project}/{id.domain}/{id.name}\222A \032\036"
  "Retrieve a NamedEntity object.\022\363\001\n\021Updat"
  "eNamedEntity\022(.flyteidl.admin.NamedEntit"
  "yUpdateRequest\032).flyteidl.admin.NamedEnt"
  "ityUpdateResponse\"\210\001\202\323\344\223\002N\032I/api/v1/name"
  "d_entities/{resource_type}/{id.project}/"
  "{id.domain}/{id.name}:\001*\222A1\032/Update the "
  "fields associated with a NamedEntityB5Z3"
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fservice_2fadmin_2eproto = {
  ...
  "flyteidl/service/admin.proto", &assign_descriptors_table_flyteidl_2fservice_2fadmin_2eproto, 12499,
};
