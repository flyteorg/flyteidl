...
type TaskMetadata struct {
	...
	// Indicates whether the system should attempt to reserve the task's output to avoid duplicate executions
	DiscoveryReservable  bool     `protobuf:"varint,9,opt,name=discovery_reservable,json=discoveryReservable,proto3" json:"discovery_reservable,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TaskMetadata) GetDiscoveryReservable() bool {
	if m != nil {
		return m.DiscoveryReservable
	}
	return false
}
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
