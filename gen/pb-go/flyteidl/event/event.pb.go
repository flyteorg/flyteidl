...
func (m *ManagedResourceInfo) GetAllocationToken() string {
	if m != nil {
...
func (m *ManagedResourceInfo) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
type TaskExecutionMetadata struct {
	...
	ManagedResourceInfo  []*ManagedResourceInfo `protobuf:"bytes,2,rep,name=managed_resource_info,json=managedResourceInfo,proto3" json:"managed_resource_info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *TaskExecutionMetadata) GetResourceName() string {
	if m != nil {
...
var fileDescriptor_4b035d24120b1b12 = []byte{
	...
	,
}
