...
func (*FutureTaskDocument) Descriptor() ([]byte, []int) {
	return fileDescriptor_future_e018305e92ec5bf7, []int{0}
}
...
func (*FutureTaskNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_future_e018305e92ec5bf7, []int{1}
}
...
func (*HiveQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_future_e018305e92ec5bf7, []int{2}
}
...
func (*HiveQueryCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_future_e018305e92ec5bf7, []int{3}
}
...
func (*SwarmDefinition) Descriptor() ([]byte, []int) {
	return fileDescriptor_future_e018305e92ec5bf7, []int{4}
}
...
func (*ArrayJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_future_e018305e92ec5bf7, []int{5}
}
...
func (*DataLocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_future_e018305e92ec5bf7, []int{6}
}
...
func init() { proto.RegisterFile("flyteidl/core/future.proto", fileDescriptor_future_e018305e92ec5bf7) }

var fileDescriptor_future_e018305e92ec5bf7 = []byte{
	// 580 bytes of a gzipped FileDescriptorProto
	,
}
