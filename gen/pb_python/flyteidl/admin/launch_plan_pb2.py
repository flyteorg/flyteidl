...
_LAUNCHPLANSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raw_output_data_prefix', full_name='flyteidl.admin.LaunchPlanSpec.raw_output_data_prefix', index=10,
