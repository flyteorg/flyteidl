...
type GPUAccelerator_Size struct {
	Size string `protobuf:"bytes,2,opt,name=size,proto3,oneof"`
}

func (*GPUAccelerator_Size) isGPUAccelerator_Partition() {}
...
func (m *GPUAccelerator) GetSize() string {
	if x, ok := m.GetPartition().(*GPUAccelerator_Size); ok {
		return x.Size
	}
	return ""
}
...
type Resources struct {
	...
	//	*Resources_Gpu
	Accelerator          isResources_Accelerator `protobuf_oneof:"accelerator"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
type isResources_Accelerator interface {
	isResources_Accelerator()
}

type Resources_Gpu struct {
	Gpu *GPUAccelerator `protobuf:"bytes,3,opt,name=gpu,proto3,oneof"`
}

func (*Resources_Gpu) isResources_Accelerator() {}

func (m *Resources) GetAccelerator() isResources_Accelerator {
	if m != nil {
...
func (m *Resources) GetGpu() *GPUAccelerator {
	if x, ok := m.GetAccelerator().(*Resources_Gpu); ok {
		return x.Gpu
	}
	return nil
}
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
