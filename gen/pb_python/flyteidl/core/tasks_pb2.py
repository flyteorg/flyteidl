...
_DECKMETADATA = _descriptor.Descriptor(
  name='DeckMetadata',
  full_name='flyteidl.core.DeckMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='uri', full_name='flyteidl.core.DeckMetadata.uri', index=0,
...
_TASKMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deck', full_name='flyteidl.core.TaskMetadata.deck', index=8,
...
_TASKMETADATA.fields_by_name['deck'].message_type = _DECKMETADATA
...
DESCRIPTOR.message_types_by_name['DeckMetadata'] = _DECKMETADATA
...
DeckMetadata = _reflection.GeneratedProtocolMessageType('DeckMetadata', (_message.Message,), dict(
  DESCRIPTOR = _DECKMETADATA,
  __module__ = 'flyteidl.core.tasks_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.DeckMetadata)
  ))
_sym_db.RegisterMessage(DeckMetadata)
