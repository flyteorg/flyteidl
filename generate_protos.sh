...
protoc --doc_out=protos/docs/admin --doc_opt=restructuredtext,admin.rst -I=protos `echo $admin_proto_files`
...
protoc --doc_out=protos/docs/event --doc_opt=restructuredtext,event.rst -I=protos `echo $event_proto_files`
...
protoc --doc_out=protos/docs/plugins --doc_opt=restructuredtext,plugins.rst -I=protos -I=tmp/doc_gen_deps `echo $plugins_proto_files`
...
protoc --doc_out=protos/docs/service --doc_opt=restructuredtext,service.rst -I=protos -I=tmp/doc_gen_deps `echo $service_proto_files`
