...
// RetrieveAndLockExecution provides a mock function with given fields: ctx, in, opts
func (_m *AdminServiceClient) RetrieveAndLockExecution(ctx context.Context, in *admin.RetrieveAndLockExecutionRequest, opts ...grpc.CallOption) (*admin.RetrieveAndLockExecutionResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *admin.RetrieveAndLockExecutionResponse
	if rf, ok := ret.Get(0).(func(context.Context, *admin.RetrieveAndLockExecutionRequest, ...grpc.CallOption) *admin.RetrieveAndLockExecutionResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*admin.RetrieveAndLockExecutionResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *admin.RetrieveAndLockExecutionRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
