...
_EXECUTIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cluster_assignment', full_name='flyteidl.admin.ExecutionSpec.cluster_assignment', index=11,
