...
_NODEEXECUTIONRECOVERRESPONSE = _descriptor.Descriptor(
  name='NodeExecutionRecoverResponse',
  full_name='flyteidl.admin.NodeExecutionRecoverResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='closure', full_name='flyteidl.admin.NodeExecutionRecoverResponse.closure', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='flyteidl.admin.NodeExecutionRecoverResponse.data', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NODEEXECUTIONRECOVERRESPONSE.fields_by_name['closure'].message_type = _NODEEXECUTIONCLOSURE
_NODEEXECUTIONRECOVERRESPONSE.fields_by_name['data'].message_type = _NODEEXECUTIONGETDATARESPONSE
...
DESCRIPTOR.message_types_by_name['NodeExecutionRecoverResponse'] = _NODEEXECUTIONRECOVERRESPONSE
...
NodeExecutionRecoverResponse = _reflection.GeneratedProtocolMessageType('NodeExecutionRecoverResponse', (_message.Message,), dict(
  DESCRIPTOR = _NODEEXECUTIONRECOVERRESPONSE,
  __module__ = 'flyteidl.admin.node_execution_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.admin.NodeExecutionRecoverResponse)
  ))
_sym_db.RegisterMessage(NodeExecutionRecoverResponse)
