...
_EXECUTIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='workflow_overrides', full_name='flyteidl.admin.ExecutionSpec.workflow_overrides', index=8,
      number=17, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTIONSPEC.fields_by_name['workflow_overrides'].message_type = flyteidl_dot_admin_dot_launch__plan__pb2._WORKFLOWTEMPLATEOVERRIDES
