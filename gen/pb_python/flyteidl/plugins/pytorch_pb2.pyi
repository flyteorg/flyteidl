...
class DistributedPyTorchTrainingTask(_message.Message):
    ...
    nProcPerNode: int
    workers: int
    def __init__(self, workers: _Optional[int] = ..., minReplicas: _Optional[int] = ..., maxReplicas: _Optional[int] = ..., RDZVBackend: _Optional[str] = ..., nProcPerNode: _Optional[int] = ..., maxRestarts: _Optional[int] = ...) -> None: ...
