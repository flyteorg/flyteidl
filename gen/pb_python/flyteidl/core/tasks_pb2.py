...
from flyteidl.core import common_pb2 as flyteidl_dot_core_dot_common__pb2
...
_TASKTEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='secrets', full_name='flyteidl.core.TaskTemplate.secrets', index=7,
...
_TASKTEMPLATE.fields_by_name['secrets'].message_type = flyteidl_dot_core_dot_common__pb2._SECRET
