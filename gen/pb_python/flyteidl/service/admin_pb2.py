...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='RetrieveAndLockExecution',
    full_name='flyteidl.service.AdminService.RetrieveAndLockExecution',
    index=28,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_execution__pb2._RETRIEVEANDLOCKEXECUTIONREQUEST,
    output_type=flyteidl_dot_admin_dot_execution__pb2._RETRIEVEANDLOCKEXECUTIONRESPONSE,
    serialized_options=_b('\202\323\344\223\002 \"\033/api/v1/executions/retrieve:\001*\222A\353\001\032\350\001Retrieves an eligible Execution to be processed by FlytePropeller.  The execution will be locked and provides strong transactional semantics. Only one processor will get one execution. Routing rules are used to determine is eligible'),
  ),
  _descriptor.MethodDescriptor(
