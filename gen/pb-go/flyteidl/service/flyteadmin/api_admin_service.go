...
/* 
AdminServiceApiService Fetches FlyteKit metrics for a :ref:&#x60;ref_flyteidl.admin.NodeExecution&#x60;.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return AdminWorkflowExecutionGetMetricsResponse
*/
func (a *AdminServiceApiService) GetFlyteKitMetrics(ctx context.Context, idExecutionIdProject string, idExecutionIdDomain string, idExecutionIdName string, idNodeId string) (AdminWorkflowExecutionGetMetricsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
