...
type OutputReference struct {
	...
	AttrPath             []*PromiseAtrribute `protobuf:"bytes,3,rep,name=attr_path,json=attrPath,proto3" json:"attr_path,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *OutputReference) GetAttrPath() []*PromiseAtrribute {
	if m != nil {
		return m.AttrPath
	}
	return nil
...
type PromiseAtrribute struct {
	// Types that are valid to be assigned to Value:
	//	*PromiseAtrribute_StringValue
	//	*PromiseAtrribute_IntValue
	Value                isPromiseAtrribute_Value `protobuf_oneof:"value"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}

func (m *PromiseAtrribute) Reset()         { *m = PromiseAtrribute{} }
func (m *PromiseAtrribute) String() string { return proto.CompactTextString(m) }
func (*PromiseAtrribute) ProtoMessage()    {}
func (*PromiseAtrribute) Descriptor() ([]byte, []int) {
	return fileDescriptor_51e8add38f4caaed, []int{9}
}

func (m *PromiseAtrribute) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PromiseAtrribute.Unmarshal(m, b)
}
func (m *PromiseAtrribute) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PromiseAtrribute.Marshal(b, m, deterministic)
}
func (m *PromiseAtrribute) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PromiseAtrribute.Merge(m, src)
}
func (m *PromiseAtrribute) XXX_Size() int {
	return xxx_messageInfo_PromiseAtrribute.Size(m)
}
func (m *PromiseAtrribute) XXX_DiscardUnknown() {
	xxx_messageInfo_PromiseAtrribute.DiscardUnknown(m)
}

var xxx_messageInfo_PromiseAtrribute proto.InternalMessageInfo

type isPromiseAtrribute_Value interface {
	isPromiseAtrribute_Value()
}

type PromiseAtrribute_StringValue struct {
	StringValue string `protobuf:"bytes,1,opt,name=string_value,json=stringValue,proto3,oneof"`
}

type PromiseAtrribute_IntValue struct {
	IntValue int32 `protobuf:"varint,2,opt,name=int_value,json=intValue,proto3,oneof"`
}

func (*PromiseAtrribute_StringValue) isPromiseAtrribute_Value() {}

func (*PromiseAtrribute_IntValue) isPromiseAtrribute_Value() {}

func (m *PromiseAtrribute) GetValue() isPromiseAtrribute_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *PromiseAtrribute) GetStringValue() string {
	if x, ok := m.GetValue().(*PromiseAtrribute_StringValue); ok {
		return x.StringValue
	}
	return ""
}

func (m *PromiseAtrribute) GetIntValue() int32 {
	if x, ok := m.GetValue().(*PromiseAtrribute_IntValue); ok {
		return x.IntValue
	}
	return 0
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*PromiseAtrribute) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*PromiseAtrribute_StringValue)(nil),
		(*PromiseAtrribute_IntValue)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*PromiseAtrribute)(nil), "flyteidl.core.PromiseAtrribute")
...
var fileDescriptor_51e8add38f4caaed = []byte{
	...
	,
}
