...
type Literal struct {
	...
	LiteralType          *LiteralType `protobuf:"bytes,6,opt,name=literal_type,json=literalType,proto3" json:"literal_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
type Literal_ArtifactId struct {
	ArtifactId *ArtifactID `protobuf:"bytes,7,opt,name=artifact_id,json=artifactId,proto3,oneof"`
}
...
func (*Literal_ArtifactId) isLiteral_Value() {}
...
func (m *Literal) GetArtifactId() *ArtifactID {
	if x, ok := m.GetValue().(*Literal_ArtifactId); ok {
		return x.ArtifactId
	}
	return nil
}
...
func (m *Literal) GetLiteralType() *LiteralType {
	if m != nil {
...
var fileDescriptor_a1a523b10667cdfb = []byte{
	...
	,
}
