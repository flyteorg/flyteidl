...
const ::google::protobuf::uint32 TableStruct_flyteidl_2fadmin_2ftask_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::TaskSpec, tags_),
  ~0u,  // no _has_bits_
...
const int TaskSpec::kTagsFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
    ...
    switch (tag >> 3) {
      ...
      case 2: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          ctx->extra_parse_data().SetFieldName("flyteidl.admin.TaskSpec.tags");
          object = msg->add_tags();
          if (size > end - ptr + ::google::protobuf::internal::ParseContext::kSlopBytes) {
            parser_till_end = ::google::protobuf::internal::GreedyStringParserUTF8;
            goto string_till_end;
