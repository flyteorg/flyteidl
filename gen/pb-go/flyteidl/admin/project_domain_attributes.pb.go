...
func (dst *ProjectDomainAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProjectDomainAttributes.Merge(dst, src)
}
...
func (dst *ProjectDomainAttributesUpdateRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProjectDomainAttributesUpdateRequest.Merge(dst, src)
}
...
func (dst *ProjectDomainAttributesUpdateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProjectDomainAttributesUpdateResponse.Merge(dst, src)
}
