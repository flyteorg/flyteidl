...
type NodeMetadata struct {
	...
	MaxQueueTime         string   `protobuf:"bytes,7,opt,name=max_queue_time,json=maxQueueTime,proto3" json:"max_queue_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *NodeMetadata) GetMaxQueueTime() string {
	if m != nil {
...
type WorkflowMetadata struct {
	// Total wait time a workflow can be delayed by queueing.
	MaxQueueTime         string   `protobuf:"bytes,1,opt,name=max_queue_time,json=maxQueueTime,proto3" json:"max_queue_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *WorkflowMetadata) GetMaxQueueTime() string {
	if m != nil {
		return m.MaxQueueTime
	}
	return ""
...
var fileDescriptor_fccede37486c456e = []byte{
	...
	,
}
