...
func (ExecutionMetadata_ExecutionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{6, 0}
}
...
func (*ExecutionCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{0}
}
...
func (*ExecutionCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{1}
}
...
func (*Execution) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{2}
}
...
func (*ExecutionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{3}
}
...
func (*LiteralMapBlob) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{4}
}
...
func (*ExecutionClosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{5}
}
...
func (*ExecutionMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{6}
}
...
func (*ExecutionSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_d7944cf3e6241027, []int{7}
}
...
func init() {
	proto.RegisterFile("flyteidl/admin/execution.proto", fileDescriptor_execution_d7944cf3e6241027)
}

var fileDescriptor_execution_d7944cf3e6241027 = []byte{
	// 760 bytes of a gzipped FileDescriptorProto
	,
}
