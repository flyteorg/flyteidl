...
.. _ref_flyteidl.core.DeckMetadata:
...
.. csv-table:: DeckMetadata type fields
   :header: "Field", "Type", "Label", "Description"
   :widths: auto

   "uri", ":ref:`ref_string`", "", "String location uniquely identifying where the deck HTML files are. Should start with the storage location (e.g. s3://, gs:// etc.)"
...
.. csv-table:: TaskMetadata type fields
   ...
   "deck", ":ref:`ref_flyteidl.core.DeckMetadata`", "", "Extra metadata about the deck"
