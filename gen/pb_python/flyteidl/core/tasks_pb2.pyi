...
class TaskTemplate(_message.Message):
    __slots__ = ["config", "container", "custom", "id", "interface", "k8s_pod", "metadata", "pod_template_name", "pod_template_struct", "security_context", "sql", "task_type_version", "type"]
    ...
    POD_TEMPLATE_STRUCT_FIELD_NUMBER: _ClassVar[int]
    ...
    pod_template_struct: _struct_pb2.Struct
    security_context: _security_pb2.SecurityContext
    sql: Sql
    task_type_version: int
    type: str
    def __init__(self, id: _Optional[_Union[_identifier_pb2.Identifier, _Mapping]] = ..., type: _Optional[str] = ..., metadata: _Optional[_Union[TaskMetadata, _Mapping]] = ..., interface: _Optional[_Union[_interface_pb2.TypedInterface, _Mapping]] = ..., custom: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., container: _Optional[_Union[Container, _Mapping]] = ..., k8s_pod: _Optional[_Union[K8sPod, _Mapping]] = ..., sql: _Optional[_Union[Sql, _Mapping]] = ..., task_type_version: _Optional[int] = ..., security_context: _Optional[_Union[_security_pb2.SecurityContext, _Mapping]] = ..., config: _Optional[_Mapping[str, str]] = ..., pod_template_name: _Optional[str] = ..., pod_template_struct: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
