...
class ExecutionUpdateRequest(_message.Message):
    ...
    tags: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, id: _Optional[_Union[_identifier_pb2.WorkflowExecutionIdentifier, _Mapping]] = ..., state: _Optional[_Union[ExecutionState, str]] = ..., tags: _Optional[_Iterable[str]] = ...) -> None: ...
