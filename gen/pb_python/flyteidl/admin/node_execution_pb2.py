...
_NODEEXECUTIONGETDATARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deck_uri', full_name='flyteidl.admin.NodeExecutionGetDataResponse.deck_uri', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dynamic_workflow', full_name='flyteidl.admin.NodeExecutionGetDataResponse.dynamic_workflow', index=5,
