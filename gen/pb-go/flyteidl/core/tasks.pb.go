...
func (RuntimeMetadata_RuntimeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd8423ba58d6ed80, []int{2, 0}
}
...
func (IOStrategy_UploadMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd8423ba58d6ed80, []int{7, 1}
}
...
func (Sql_Dialect) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bd8423ba58d6ed80, []int{11, 0}
}
...
type Selector struct {
	...
	//	*Selector_GpuDevice
	//	*Selector_GpuUnpartitioned
	//	*Selector_GpuPartitionSize
	Selection            isSelector_Selection `protobuf_oneof:"selection"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type isSelector_Selection interface {
	isSelector_Selection()
}

type Selector_GpuDevice struct {
	GpuDevice string `protobuf:"bytes,1,opt,name=gpu_device,json=gpuDevice,proto3,oneof"`
}

type Selector_GpuUnpartitioned struct {
	GpuUnpartitioned bool `protobuf:"varint,2,opt,name=gpu_unpartitioned,json=gpuUnpartitioned,proto3,oneof"`
}

type Selector_GpuPartitionSize struct {
	GpuPartitionSize string `protobuf:"bytes,3,opt,name=gpu_partition_size,json=gpuPartitionSize,proto3,oneof"`
}

func (*Selector_GpuDevice) isSelector_Selection() {}

func (*Selector_GpuUnpartitioned) isSelector_Selection() {}

func (*Selector_GpuPartitionSize) isSelector_Selection() {}

func (m *Selector) GetSelection() isSelector_Selection {
	if m != nil {
		return m.Selection
	}
	return nil
...
func (m *Selector) GetGpuDevice() string {
	if x, ok := m.GetSelection().(*Selector_GpuDevice); ok {
		return x.GpuDevice
	}
	return ""
}

func (m *Selector) GetGpuUnpartitioned() bool {
	if x, ok := m.GetSelection().(*Selector_GpuUnpartitioned); ok {
		return x.GpuUnpartitioned
	}
	return false
}

func (m *Selector) GetGpuPartitionSize() string {
	if x, ok := m.GetSelection().(*Selector_GpuPartitionSize); ok {
...
func (*Selector) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Selector_GpuDevice)(nil),
		(*Selector_GpuUnpartitioned)(nil),
		(*Selector_GpuPartitionSize)(nil),
	}
}
...
type TaskMetadata struct {
	...
	Selectors            []*Selector `protobuf:"bytes,13,rep,name=selectors,proto3" json:"selectors,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *TaskMetadata) GetSelectors() []*Selector {
	if m != nil {
		return m.Selectors
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Selector)(nil), "flyteidl.core.Selector")
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
