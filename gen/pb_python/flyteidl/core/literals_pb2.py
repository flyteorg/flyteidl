...
_SCHEMAMETADATA = _descriptor.Descriptor(
  name='SchemaMetadata',
  full_name='flyteidl.core.SchemaMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='format', full_name='flyteidl.core.SchemaMetadata.format', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='storage', full_name='flyteidl.core.SchemaMetadata.storage', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_schema_type', full_name='flyteidl.core.SchemaMetadata.external_schema_type', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_schema_bytes', full_name='flyteidl.core.SchemaMetadata.external_schema_bytes', index=3,
...
_EXPANDEDSCHEMA = _descriptor.Descriptor(
  name='ExpandedSchema',
  full_name='flyteidl.core.ExpandedSchema',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='flyteidl.core.ExpandedSchema.type', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uri', full_name='flyteidl.core.ExpandedSchema.uri', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='flyteidl.core.ExpandedSchema.metadata', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SCALAR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flyte_schema', full_name='flyteidl.core.Scalar.flyte_schema', index=7,
...
_EXPANDEDSCHEMA.fields_by_name['type'].message_type = flyteidl_dot_core_dot_types__pb2._EXPANDEDSCHEMATYPE
_EXPANDEDSCHEMA.fields_by_name['metadata'].message_type = _SCHEMAMETADATA
...
_SCALAR.fields_by_name['flyte_schema'].message_type = _EXPANDEDSCHEMA
...
_SCALAR.oneofs_by_name['value'].fields.append(
  _SCALAR.fields_by_name['flyte_schema'])
_SCALAR.fields_by_name['flyte_schema'].containing_oneof = _SCALAR.oneofs_by_name['value']
...
DESCRIPTOR.message_types_by_name['ExpandedSchema'] = _EXPANDEDSCHEMA
...
SchemaMetadata = _reflection.GeneratedProtocolMessageType('SchemaMetadata', (_message.Message,), dict(
...
ExpandedSchema = _reflection.GeneratedProtocolMessageType('ExpandedSchema', (_message.Message,), dict(
  DESCRIPTOR = _EXPANDEDSCHEMA,
  __module__ = 'flyteidl.core.literals_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.ExpandedSchema)
  ))
_sym_db.RegisterMessage(ExpandedSchema)
