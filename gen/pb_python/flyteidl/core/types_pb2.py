...
_CLOSURETYPE = _descriptor.Descriptor(
  name='ClosureType',
  full_name='flyteidl.core.ClosureType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='interface', full_name='flyteidl.core.ClosureType.interface', index=0,
...
_LITERALTYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='closure', full_name='flyteidl.core.LiteralType.closure', index=5,
...
_CLOSURETYPE.fields_by_name['interface'].message_type = _TYPEDINTERFACE
...
_LITERALTYPE.fields_by_name['closure'].message_type = _CLOSURETYPE
...
_LITERALTYPE.oneofs_by_name['type'].fields.append(
  _LITERALTYPE.fields_by_name['closure'])
_LITERALTYPE.fields_by_name['closure'].containing_oneof = _LITERALTYPE.oneofs_by_name['type']
_VARIABLE.fields_by_name['type'].message_type = _LITERALTYPE
...
DESCRIPTOR.message_types_by_name['ClosureType'] = _CLOSURETYPE
...
ClosureType = _reflection.GeneratedProtocolMessageType('ClosureType', (_message.Message,), dict(
  DESCRIPTOR = _CLOSURETYPE,
  __module__ = 'flyteidl.core.types_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.ClosureType)
  ))
_sym_db.RegisterMessage(ClosureType)
