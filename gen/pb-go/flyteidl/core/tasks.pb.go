...
type Container struct {
	...
	UseCopilot bool `protobuf:"varint,8,opt,name=use_copilot,json=useCopilot,proto3" json:"use_copilot,omitempty"`
	// Optional configuration for CoPilot. If not specified, then default values are used.
	CopilotConfig        *CoPilot `protobuf:"bytes,9,opt,name=copilot_config,json=copilotConfig,proto3" json:"copilot_config,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Container) GetUseCopilot() bool {
	if m != nil {
		return m.UseCopilot
	}
	return false
...
func (m *Container) GetCopilotConfig() *CoPilot {
	if m != nil {
		return m.CopilotConfig
	}
	return nil
}
...
type CoPilot struct {
	...
	Format               CoPilot_MetadataFormat `protobuf:"varint,3,opt,name=format,proto3,enum=flyteidl.core.CoPilot_MetadataFormat" json:"format,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func init() {
	...
	proto.RegisterEnum("flyteidl.core.CoPilot_MetadataFormat", CoPilot_MetadataFormat_name, CoPilot_MetadataFormat_value)
	...
	proto.RegisterType((*CoPilot)(nil), "flyteidl.core.CoPilot")
}
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
