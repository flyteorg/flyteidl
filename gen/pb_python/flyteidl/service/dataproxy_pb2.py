...
_DATAPROXYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002)\022\'/api/v1/dataproxy/download/artifact_urn\222AL\032JCreates a read-only http location that is accessible for tasks at runtime.'),
  ),
])
