...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\035\022\033/api/v1/matchable_resources\222A<\032:Retrieve a list of MatchableResourceConfiguration objects.'),
  ),
  _descriptor.MethodDescriptor(
