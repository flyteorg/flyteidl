...
// string deck_uri = 19;
inline void TaskExecutionEvent::clear_deck_uri() {
  deck_uri_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& TaskExecutionEvent::deck_uri() const {
  // @@protoc_insertion_point(field_get:flyteidl.event.TaskExecutionEvent.deck_uri)
  return deck_uri_.GetNoArena();
}
inline void TaskExecutionEvent::set_deck_uri(const ::std::string& value) {
  
  deck_uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:flyteidl.event.TaskExecutionEvent.deck_uri)
}
#if LANG_CXX11
inline void TaskExecutionEvent::set_deck_uri(::std::string&& value) {
  
  deck_uri_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:flyteidl.event.TaskExecutionEvent.deck_uri)
}
#endif
inline void TaskExecutionEvent::set_deck_uri(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  deck_uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:flyteidl.event.TaskExecutionEvent.deck_uri)
}
inline void TaskExecutionEvent::set_deck_uri(const char* value, size_t size) {
  
  deck_uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:flyteidl.event.TaskExecutionEvent.deck_uri)
}
inline ::std::string* TaskExecutionEvent::mutable_deck_uri() {
  
  // @@protoc_insertion_point(field_mutable:flyteidl.event.TaskExecutionEvent.deck_uri)
  return deck_uri_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TaskExecutionEvent::release_deck_uri() {
  // @@protoc_insertion_point(field_release:flyteidl.event.TaskExecutionEvent.deck_uri)
  
  return deck_uri_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void TaskExecutionEvent::set_allocated_deck_uri(::std::string* deck_uri) {
  if (deck_uri != nullptr) {
  ...
  deck_uri_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), deck_uri);
  // @@protoc_insertion_point(field_set_allocated:flyteidl.event.TaskExecutionEvent.deck_uri)
}
