...
func (ExecutionMetadata_ExecutionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{6, 0}
}
...
func (*ExecutionCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{0}
}
...
func (*ExecutionCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{1}
}
...
func (*Execution) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{2}
}
...
func (*ExecutionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{3}
}
...
func (*LiteralMapBlob) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{4}
}
...
type ExecutionClosure struct {
	...
	Phase                ExecutionPhase `protobuf:"varint,4,opt,name=phase,proto3,enum=flyteidl.admin.ExecutionPhase" json:"phase,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (*ExecutionClosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{5}
}
...
func (m *ExecutionClosure) GetPhase() ExecutionPhase {
	if m != nil {
		return m.Phase
	}
...
func (*ExecutionMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{6}
}
...
func (*ExecutionSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_865e5eb342cc4373, []int{7}
}
...
func init() {
	proto.RegisterFile("flyteidl/admin/execution.proto", fileDescriptor_execution_865e5eb342cc4373)
}

var fileDescriptor_execution_865e5eb342cc4373 = []byte{
	// 642 bytes of a gzipped FileDescriptorProto
	,
}
