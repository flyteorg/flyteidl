...
_LAUNCHPLANSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='entity_description', full_name='flyteidl.admin.LaunchPlanSpec.entity_description', index=14,
...
_LAUNCHPLANSPEC.fields_by_name['entity_description'].message_type = flyteidl_dot_admin_dot_entity__description__pb2._ENTITYDESCRIPTION
