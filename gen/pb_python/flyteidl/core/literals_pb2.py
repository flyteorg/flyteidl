...
_PRIMITIVE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='my_new_value', full_name='flyteidl.core.Primitive.my_new_value', index=6,
...
_PRIMITIVE.oneofs_by_name['value'].fields.append(
  _PRIMITIVE.fields_by_name['my_new_value'])
_PRIMITIVE.fields_by_name['my_new_value'].containing_oneof = _PRIMITIVE.oneofs_by_name['value']
