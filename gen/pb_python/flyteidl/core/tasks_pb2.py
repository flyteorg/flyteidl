...
_TASKMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='discovery_reservable', full_name='flyteidl.core.TaskMetadata.discovery_reservable', index=7,
