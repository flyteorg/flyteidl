...
static const char* AdminService_method_names[] = {
  ...
  "/flyteidl.service.AdminService/GetData",
...
AdminService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetData_(AdminService_method_names[27], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status AdminService::Stub::GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::flyteidl::admin::DataResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetData_, context, request, response);
}

void AdminService::Stub::experimental_async::GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetData_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::GetData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::DataResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetData_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::GetData(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void AdminService::Stub::experimental_async::GetData(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::DataResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetData_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>* AdminService::Stub::AsyncGetDataRaw(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::DataResponse>::Create(channel_.get(), cq, rpcmethod_GetData_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::DataResponse>* AdminService::Stub::PrepareAsyncGetDataRaw(::grpc::ClientContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::DataResponse>::Create(channel_.get(), cq, rpcmethod_GetData_, context, request, false);
}
...
AdminService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AdminService::Service, ::flyteidl::admin::FlyteArtifactGetRequest, ::flyteidl::admin::DataResponse>(
          std::mem_fn(&AdminService::Service::GetData), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status AdminService::Service::GetData(::grpc::ServerContext* context, const ::flyteidl::admin::FlyteArtifactGetRequest* request, ::flyteidl::admin::DataResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
