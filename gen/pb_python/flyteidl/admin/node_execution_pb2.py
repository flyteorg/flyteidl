...
_NODEEXECUTIONCLOSURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dynamic_workflow_node_metadata', full_name='flyteidl.admin.NodeExecutionClosure.dynamic_workflow_node_metadata', index=9,
...
_NODEEXECUTIONCLOSURE.fields_by_name['dynamic_workflow_node_metadata'].message_type = _DYNAMICWORKFLOWNODEMETADATA
...
_NODEEXECUTIONCLOSURE.oneofs_by_name['target_metadata'].fields.append(
  _NODEEXECUTIONCLOSURE.fields_by_name['dynamic_workflow_node_metadata'])
_NODEEXECUTIONCLOSURE.fields_by_name['dynamic_workflow_node_metadata'].containing_oneof = _NODEEXECUTIONCLOSURE.oneofs_by_name['target_metadata']
