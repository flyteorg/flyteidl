...
type Container struct {
	...
	UseDataLoading bool `protobuf:"varint,8,opt,name=use_data_loading,json=useDataLoading,proto3" json:"use_data_loading,omitempty"`
...
func (m *Container) GetUseDataLoading() bool {
	if m != nil {
		return m.UseDataLoading
	}
	return false
}
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
