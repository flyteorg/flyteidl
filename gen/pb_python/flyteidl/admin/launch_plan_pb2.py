...
_LAUNCHPLANSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description_entity', full_name='flyteidl.admin.LaunchPlanSpec.description_entity', index=14,
...
_LAUNCHPLANSPEC.fields_by_name['description_entity'].message_type = flyteidl_dot_admin_dot_description__entity__pb2._DESCRIPTIONENTITY
