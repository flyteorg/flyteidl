...
type DataResponse struct {
	...
	//	*DataResponse_FlyteDeckDownloadLink
...
type DataResponse_FlyteDeckDownloadLink struct {
...
func (*DataResponse_FlyteDeckDownloadLink) isDataResponse_Data() {}
...
func (m *DataResponse) GetFlyteDeckDownloadLink() *CreateDownloadLinkResponse {
	if x, ok := m.GetData().(*DataResponse_FlyteDeckDownloadLink); ok {
...
func (*DataResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*DataResponse_FlyteDeckDownloadLink)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*FlyteArtifact)(nil), "flyteidl.service.FlyteArtifact")
	proto.RegisterType((*FlyteArtifactGetRequest)(nil), "flyteidl.service.FlyteArtifactGetRequest")
	proto.RegisterType((*DataResponse)(nil), "flyteidl.service.DataResponse")
}
...
var fileDescriptor_bffb71366d75dab0 = []byte{
	...
	,
}
...
type DataProxyServiceClient interface {
	...
	GetData(ctx context.Context, in *FlyteArtifactGetRequest, opts ...grpc.CallOption) (*DataResponse, error)
}
...
func (c *dataProxyServiceClient) GetData(ctx context.Context, in *FlyteArtifactGetRequest, opts ...grpc.CallOption) (*DataResponse, error) {
...
type DataProxyServiceServer interface {
	...
	GetData(context.Context, *FlyteArtifactGetRequest) (*DataResponse, error)
}
...
func (*UnimplementedDataProxyServiceServer) GetData(ctx context.Context, req *FlyteArtifactGetRequest) (*DataResponse, error) {
...
func _DataProxyService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FlyteArtifactGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataProxyServiceServer).GetData(ctx, req.(*FlyteArtifactGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
