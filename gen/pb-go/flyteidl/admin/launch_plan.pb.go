...
type LaunchPlanSpec struct {
	...
	Resources            map[string]*core.Resource `protobuf:"bytes,20,rep,name=resources,proto3" json:"resources,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *LaunchPlanSpec) GetResources() map[string]*core.Resource {
	if m != nil {
		return m.Resources
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*core.Resource)(nil), "flyteidl.admin.LaunchPlanSpec.ResourcesEntry")
...
var fileDescriptor_368a863574f5e699 = []byte{
	...
	,
}
