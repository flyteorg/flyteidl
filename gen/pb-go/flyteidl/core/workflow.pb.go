...
func (m *NodeMetadata) GetDuration() string {
	if m != nil {
		return m.Duration
	}
	return ""
...
func (m *WorkflowMetadata) GetDuration() string {
	if m != nil {
		return m.Duration
	}
	return ""
...
var fileDescriptor_fccede37486c456e = []byte{
	...
	,
}
