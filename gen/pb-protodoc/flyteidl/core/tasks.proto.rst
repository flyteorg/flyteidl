...
.. _api_field_flyteidl.core.Container.use_data_loading:

use_data_loading
  (`bool <https://developers.google.com/protocol-buffers/docs/proto#scalar>`_) BETA: This enables use of CoPilot or automated data loading into the contaiiner. This makes it possible to to run a completely portable container, that uses inputs and outputs
...
data_config
  (:ref:`flyteidl.core.DataLoadingConfig <api_msg_flyteidl.core.DataLoadingConfig>`) Optional configuration for CoPilot. If not specified, then default values are used.
