...
type TaskTemplate struct {
	...
	CustomConfig         map[string]string `protobuf:"bytes,16,rep,name=custom_config,json=customConfig,proto3" json:"custom_config,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *TaskTemplate) GetCustomConfig() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "flyteidl.core.TaskTemplate.CustomConfigEntry")
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
