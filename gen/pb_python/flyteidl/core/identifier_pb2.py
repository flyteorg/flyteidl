...
_RESOURCETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DESCRIPTION_ENTITY', index=5, number=5,
      serialized_options=None,
      type=None),
  ],
