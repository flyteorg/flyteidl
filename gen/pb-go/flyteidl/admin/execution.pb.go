...
func (ExecutionMetadata_ExecutionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{7, 0}
}
...
func (*ExecutionCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{0}
}
...
func (*ExecutionCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{1}
}
...
type Execution struct {
	...
	Closure              *ExecutionClosure `protobuf:"bytes,5,opt,name=closure,proto3" json:"closure,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*Execution) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{2}
}
...
func (*ExecutionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{3}
}
...
func (*ExecutionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{4}
}
...
func (*LiteralMapBlob) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{5}
}
...
func (*ExecutionClosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{6}
}
...
func (m *ExecutionClosure) GetError() *Error {
...
func (*ExecutionMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{7}
}
...
func (*ExecutionSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a75f00bf2114d4ea, []int{8}
}
...
func init() {
	proto.RegisterFile("flyteidl/admin/execution.proto", fileDescriptor_execution_a75f00bf2114d4ea)
}

var fileDescriptor_execution_a75f00bf2114d4ea = []byte{
	// 683 bytes of a gzipped FileDescriptorProto
	,
}
