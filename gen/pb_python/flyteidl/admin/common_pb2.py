...
_GETEXECUTIONDATA_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='flyteidl.admin.GetExecutionData.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='URL_BLOB_ONLY', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FULL_DATA', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_GETEXECUTIONDATA_MODE)
...
_GETEXECUTIONDATA = _descriptor.Descriptor(
  name='GetExecutionData',
  full_name='flyteidl.admin.GetExecutionData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_GETEXECUTIONDATA_MODE.containing_type = _GETEXECUTIONDATA
...
DESCRIPTOR.message_types_by_name['GetExecutionData'] = _GETEXECUTIONDATA
...
GetExecutionData = _reflection.GeneratedProtocolMessageType('GetExecutionData', (_message.Message,), dict(
  DESCRIPTOR = _GETEXECUTIONDATA,
  __module__ = 'flyteidl.admin.common_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.admin.GetExecutionData)
  ))
_sym_db.RegisterMessage(GetExecutionData)
