...
_DESCRIPTIONENTITY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tags', full_name='flyteidl.admin.DescriptionEntity.tags', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='labels', full_name='flyteidl.admin.DescriptionEntity.labels', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_code', full_name='flyteidl.admin.DescriptionEntity.source_code', index=4,
...
_DESCRIPTIONENTITY.fields_by_name['labels'].message_type = flyteidl_dot_admin_dot_common__pb2._LABELS
