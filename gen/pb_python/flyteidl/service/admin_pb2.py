...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetProject',
    full_name='flyteidl.service.AdminService.GetProject',
    index=28,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_project__pb2._GETPROJECTREQUEST,
    output_type=flyteidl_dot_admin_dot_project__pb2._PROJECTREGISTERRESPONSE,
    serialized_options=_b('\202\323\344\223\002\027\022\025/api/v1/projects/{id}\222A\025\032\023Retrieve a project.'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateProject',
