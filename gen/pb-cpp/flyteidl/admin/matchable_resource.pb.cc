...
const ::google::protobuf::uint32 TableStruct_flyteidl_2fadmin_2fmatchable_5fresource_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::WorkflowExecutionConfig, skip_cache_),
  ~0u,  // no _has_bits_
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fadmin_2fmatchable_5fresource_2eproto = {
  ...
  "flyteidl/admin/matchable_resource.proto", &assign_descriptors_table_flyteidl_2fadmin_2fmatchable_5fresource_2eproto, 2573,
};
...
const int WorkflowExecutionConfig::kSkipCacheFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
void WorkflowExecutionConfig::SharedCtor() {
  ...
  ::memset(&security_context_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&security_context_)) + sizeof(skip_cache_));
}
...
void WorkflowExecutionConfig::SerializeWithCachedSizes(
  ...
  if (this->skip_cache() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(7, this->skip_cache(), output);
  }
...
::google::protobuf::uint8* WorkflowExecutionConfig::InternalSerializeWithCachedSizesToArray(
  ...
  // bool skip_cache = 7;
  if (this->skip_cache() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(7, this->skip_cache(), target);
  }
