...
type ExecutionRelaunchRequest struct {
	...
	SkipCache            bool     `protobuf:"varint,4,opt,name=skip_cache,json=skipCache,proto3" json:"skip_cache,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ExecutionRelaunchRequest) GetSkipCache() bool {
	if m != nil {
		return m.SkipCache
	}
	return false
...
type ExecutionSpec struct {
	...
	// If enabled, all calculations are performed even if cached results would be available, overwriting the stored
	// data once execution finishes successfully.
	SkipCache            bool     `protobuf:"varint,22,opt,name=skip_cache,json=skipCache,proto3" json:"skip_cache,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ExecutionSpec) GetSkipCache() bool {
	if m != nil {
		return m.SkipCache
	}
	return false
...
var fileDescriptor_4e2785d91b3809ec = []byte{
	...
	,
}
