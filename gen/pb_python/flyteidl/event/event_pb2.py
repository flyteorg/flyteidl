...
_RESOURCEIDENTIFIERS = _descriptor.Descriptor(
  name='ResourceIdentifiers',
  full_name='flyteidl.event.ResourceIdentifiers',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='generated_name', full_name='flyteidl.event.ResourceIdentifiers.generated_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_ids', full_name='flyteidl.event.ResourceIdentifiers.external_ids', index=1,
...
DESCRIPTOR.message_types_by_name['ResourceIdentifiers'] = _RESOURCEIDENTIFIERS
...
ResourceIdentifiers = _reflection.GeneratedProtocolMessageType('ResourceIdentifiers', (_message.Message,), dict(
  DESCRIPTOR = _RESOURCEIDENTIFIERS,
  __module__ = 'flyteidl.event.event_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.event.ResourceIdentifiers)
  ))
_sym_db.RegisterMessage(ResourceIdentifiers)
