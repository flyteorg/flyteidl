...
const (
	...
	QualityOfService_QUALITY_OF_SERVICE_UNDEFINED QualityOfService = 0
	// Guarantees that this execution will begin as soon as requested and incur no queueing time.
	QualityOfService_QUALITY_OF_SERVICE_HIGH QualityOfService = 1
	// This execution may incur some queueing delay (e.g. 30 minutes) and is medium priority.
	QualityOfService_QUALITY_OF_SERVICE_MEDIUM QualityOfService = 2
	// This execution may incur significant queueing delay (e.g. 2 hours) and is low priority.
	QualityOfService_QUALITY_OF_SERVICE_LOW QualityOfService = 3
)

var QualityOfService_name = map[int32]string{
	0: "QUALITY_OF_SERVICE_UNDEFINED",
	1: "QUALITY_OF_SERVICE_HIGH",
	2: "QUALITY_OF_SERVICE_MEDIUM",
	3: "QUALITY_OF_SERVICE_LOW",
}
...
var fileDescriptor_7c2cf612a185829c = []byte{
	...
	,
}
