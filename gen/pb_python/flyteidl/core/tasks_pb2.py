...
_TASKMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='discovery_serializable', full_name='flyteidl.core.TaskMetadata.discovery_serializable', index=7,
