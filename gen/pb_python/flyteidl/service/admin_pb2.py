...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002z\022?/api/v1/description_entities/{id.project}/{id.domain}/{id.name}Z7\0225/api/v1/description_entities/{id.project}/{id.domain}\222AG\032EFetch existing description entity definitions matching input filters.'),
  ),
])
