...
type DataProxyServiceServer_ResolveArtifact struct {
	*mock.Call
}

func (_m DataProxyServiceServer_ResolveArtifact) Return(_a0 *service.ResolveArtifactResponse, _a1 error) *DataProxyServiceServer_ResolveArtifact {
...
func (_m *DataProxyServiceServer) OnResolveArtifactMatch(matchers ...interface{}) *DataProxyServiceServer_ResolveArtifact {
