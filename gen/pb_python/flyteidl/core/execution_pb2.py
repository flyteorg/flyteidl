...
_WORKFLOWEXECUTION_PHASE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECOVERED', index=9, number=9,
      serialized_options=None,
      type=None),
  ],
