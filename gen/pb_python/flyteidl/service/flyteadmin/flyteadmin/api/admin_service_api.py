...
class AdminServiceApi(object):
    ...
    def recover_execution(self, body, **kwargs):  # noqa: E501
        """recover_execution  # noqa: E501

        Recovers a previously-run workflow execution that failed due to system failure.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def recover_node_execution(self, id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs):  # noqa: E501
        """recover_node_execution  # noqa: E501

        Recovers already produced data from an existing node execution (if any).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recover_node_execution(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.recover_node_execution_with_http_info(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs)  # noqa: E501
        else:
            (data) = self.recover_node_execution_with_http_info(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs)  # noqa: E501
            return data

    def recover_node_execution_with_http_info(self, id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs):  # noqa: E501
        """recover_node_execution  # noqa: E501

        Recovers already produced data from an existing node execution (if any).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recover_node_execution_with_http_info(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method recover_node_execution" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id_execution_id_project' is set
        if ('id_execution_id_project' not in params or
                params['id_execution_id_project'] is None):
            raise ValueError("Missing the required parameter `id_execution_id_project` when calling `recover_node_execution`")  # noqa: E501
        # verify the required parameter 'id_execution_id_domain' is set
        if ('id_execution_id_domain' not in params or
                params['id_execution_id_domain'] is None):
            raise ValueError("Missing the required parameter `id_execution_id_domain` when calling `recover_node_execution`")  # noqa: E501
        # verify the required parameter 'id_execution_id_name' is set
        if ('id_execution_id_name' not in params or
                params['id_execution_id_name'] is None):
            raise ValueError("Missing the required parameter `id_execution_id_name` when calling `recover_node_execution`")  # noqa: E501
        # verify the required parameter 'id_node_id' is set
        if ('id_node_id' not in params or
                params['id_node_id'] is None):
            raise ValueError("Missing the required parameter `id_node_id` when calling `recover_node_execution`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/node_executions/recover/{id.execution_id.project}/{id.execution_id.domain}/{id.execution_id.name}/{id.node_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
