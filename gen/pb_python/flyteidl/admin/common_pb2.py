...
_QUALITYOFSERVICE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='QUALITY_OF_SERVICE_HIGH', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUALITY_OF_SERVICE_MEDIUM', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUALITY_OF_SERVICE_LOW', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
