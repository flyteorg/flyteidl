...
goog.provide('proto.flyteidl.core.CompiledTask');
...
proto.flyteidl.core.CompiledTask.toObject = function(includeInstance, msg) {
  var f, obj = {
    template: (f = msg.getTemplate()) && proto.flyteidl.core.TaskTemplate.toObject(includeInstance, f)
  };
...
proto.flyteidl.core.CompiledTask.prototype.getTemplate = function() {
  return /** @type{?proto.flyteidl.core.TaskTemplate} */ (
    jspb.Message.getWrapperField(this, proto.flyteidl.core.TaskTemplate, 1));
};
