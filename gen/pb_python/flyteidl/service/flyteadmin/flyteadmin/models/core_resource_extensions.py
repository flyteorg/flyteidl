...
class CoreResourceExtensions(object):
    ...
    def __init__(self, gpu_accelerator=None):  # noqa: E501
        """CoreResourceExtensions - a model defined in Swagger"""  # noqa: E501
    ...
    def gpu_accelerator(self):
        """Gets the gpu_accelerator of this CoreResourceExtensions.  # noqa: E501
        ...
        :return: The gpu_accelerator of this CoreResourceExtensions.  # noqa: E501
    ...
    def gpu_accelerator(self, gpu_accelerator):
        """Sets the gpu_accelerator of this CoreResourceExtensions.

        GPU accelerator to select for task. Contains information about device type, and for multi-instance GPUs, the partition size to use.  # noqa: E501

        :param gpu_accelerator: The gpu_accelerator of this CoreResourceExtensions.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CoreResourceExtensions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreResourceExtensions):
            return False
