...
_UNIONTYPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='values', full_name='flyteidl.core.UnionType.values', index=0,
...
_LITERALTYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='union_type', full_name='flyteidl.core.LiteralType.union_type', index=6,
...
_UNIONTYPE.fields_by_name['values'].message_type = _LITERALTYPE
