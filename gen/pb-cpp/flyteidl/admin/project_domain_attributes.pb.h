...
#ifndef PROTOBUF_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto__INCLUDED
#define PROTOBUF_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsProjectDomainAttributes_AttributesEntry_DoNotUse();
  InitDefaultsProjectDomainAttributes();
  InitDefaultsProjectDomainAttributesUpdateRequest();
  InitDefaultsProjectDomainAttributesUpdateResponse();
}
}  // namespace protobuf_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto
namespace flyteidl {
namespace admin {
...
class ProjectDomainAttributes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.admin.ProjectDomainAttributes) */ {
 public:
  ...
  inline ProjectDomainAttributes* New() const PROTOBUF_FINAL { return New(NULL); }

  ProjectDomainAttributes* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto::InitDefaultsProjectDomainAttributesImpl();
};
// -------------------------------------------------------------------

class ProjectDomainAttributesUpdateRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.admin.ProjectDomainAttributesUpdateRequest) */ {
 public:
  ...
  inline ProjectDomainAttributesUpdateRequest* New() const PROTOBUF_FINAL { return New(NULL); }

  ProjectDomainAttributesUpdateRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto::InitDefaultsProjectDomainAttributesUpdateRequestImpl();
};
// -------------------------------------------------------------------

class ProjectDomainAttributesUpdateResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.admin.ProjectDomainAttributesUpdateResponse) */ {
 public:
  ...
  inline ProjectDomainAttributesUpdateResponse* New() const PROTOBUF_FINAL { return New(NULL); }

  ProjectDomainAttributesUpdateResponse* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto::InitDefaultsProjectDomainAttributesUpdateResponseImpl();
};
// ===================================================================
...
inline const ::flyteidl::admin::ProjectDomainAttributes& ProjectDomainAttributesUpdateRequest::attributes() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::flyteidl::admin::ProjectDomainAttributes*>(
...
inline ::flyteidl::admin::ProjectDomainAttributes* ProjectDomainAttributesUpdateRequest::mutable_attributes() {
  ...
  if (attributes_ == NULL) {
    attributes_ = new ::flyteidl::admin::ProjectDomainAttributes;
  }
...
#endif  // PROTOBUF_flyteidl_2fadmin_2fproject_5fdomain_5fattributes_2eproto__INCLUDED
