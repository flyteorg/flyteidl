...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0024\022//api/v1/project_attributes/{attributes.project}:\001*\222AG\032ERetrieve the customized resource attributes associated with a project'),
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002O\022J/api/v1/project_domain_attributes/{attributes.project}/{attributes.domain}:\001*\222AZ\032XRetrieve the customized resource attributes associated with a project-domain combination'),
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002_\022Z/api/v1/workflow_attributes/{attributes.project}/{attributes.domain}/{attributes.workflow}:\001*\222Ah\032fRetrieve the customized resource attributes associated with a project, domain and workflow combination'),
  ),
  _descriptor.MethodDescriptor(
