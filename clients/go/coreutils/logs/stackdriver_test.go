...
func Test_stackdriverLogPlugin_GetTaskLog(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"podName-proj1",
			fields{gcpProject: "lyft-level5", logResource: "aws_ec2_instance"},
			args{podName: "podName"},
			core.TaskLog{Uri: "https://console.cloud.google.com/logs/viewer?project=lyft-level5&angularJsUrl=%2Flogs%2Fviewer%3Fproject%3Dlyft-level5&authuser=1&resource=aws_ec2_instance&advancedFilter=logName:podName", MessageFormat: core.TaskLog_JSON}, false,
		},
		{
			"podName2-proj2",
