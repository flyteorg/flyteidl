...
_ARRAYNODE = _descriptor.Descriptor(
  name='ArrayNode',
  full_name='flyteidl.core.ArrayNode',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='task_reference', full_name='flyteidl.core.ArrayNode.task_reference', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='concurrency', full_name='flyteidl.core.ArrayNode.concurrency', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='size', full_name='flyteidl.core.ArrayNode.size', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_success_ratio', full_name='flyteidl.core.ArrayNode.min_success_ratio', index=3,
...
_NODE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='array_node', full_name='flyteidl.core.Node.array_node', index=8,
...
_ARRAYNODE.fields_by_name['task_reference'].message_type = flyteidl_dot_core_dot_identifier__pb2._IDENTIFIER
...
_NODE.fields_by_name['array_node'].message_type = _ARRAYNODE
...
_NODE.oneofs_by_name['target'].fields.append(
  _NODE.fields_by_name['array_node'])
_NODE.fields_by_name['array_node'].containing_oneof = _NODE.oneofs_by_name['target']
...
DESCRIPTOR.message_types_by_name['ArrayNode'] = _ARRAYNODE
...
ArrayNode = _reflection.GeneratedProtocolMessageType('ArrayNode', (_message.Message,), dict(
  DESCRIPTOR = _ARRAYNODE,
  __module__ = 'flyteidl.core.workflow_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.ArrayNode)
  ))
_sym_db.RegisterMessage(ArrayNode)
