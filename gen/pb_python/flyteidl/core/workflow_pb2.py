...
_WORKFLOWMETADATA_FAILUREHANDLINGSTRATEGY = _descriptor.EnumDescriptor(
  name='FailureHandlingStrategy',
  full_name='flyteidl.core.WorkflowMetadata.FailureHandlingStrategy',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WAIT_FOR_RUNNING_NODES', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WAIT_FOR_EXECUTABLE_BRANCHES', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
...
_sym_db.RegisterEnumDescriptor(_WORKFLOWMETADATA_FAILUREHANDLINGSTRATEGY)
...
_WORKFLOWMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='failure_handling_strategy', full_name='flyteidl.core.WorkflowMetadata.failure_handling_strategy', index=1,
  ...
  nested_types=[],
  enum_types=[
    _WORKFLOWMETADATA_FAILUREHANDLINGSTRATEGY,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_WORKFLOWMETADATA.fields_by_name['failure_handling_strategy'].enum_type = _WORKFLOWMETADATA_FAILUREHANDLINGSTRATEGY
_WORKFLOWMETADATA_FAILUREHANDLINGSTRATEGY.containing_type = _WORKFLOWMETADATA
