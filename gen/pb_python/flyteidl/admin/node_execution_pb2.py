...
_NODEEXECUTIONCLOSURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dynamic_job_spec_uri', full_name='flyteidl.admin.NodeExecutionClosure.dynamic_job_spec_uri', index=11,
...
_DYNAMICWORKFLOWNODEMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dynamic_job_spec_uri', full_name='flyteidl.admin.DynamicWorkflowNodeMetadata.dynamic_job_spec_uri', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NODEEXECUTIONGETDATARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flyte_urls', full_name='flyteidl.admin.NodeExecutionGetDataResponse.flyte_urls', index=5,
...
_NODEEXECUTIONGETDATARESPONSE.fields_by_name['flyte_urls'].message_type = flyteidl_dot_admin_dot_common__pb2._FLYTEURLS
