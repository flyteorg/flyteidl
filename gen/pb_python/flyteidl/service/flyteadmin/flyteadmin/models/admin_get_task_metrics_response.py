...
class AdminGetTaskMetricsResponse(object):
    ...
    def __init__(self, span=None):  # noqa: E501
        """AdminGetTaskMetricsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AdminGetTaskMetricsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdminGetTaskMetricsResponse):
            return False
