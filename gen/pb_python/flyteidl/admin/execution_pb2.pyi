...
class ExecutionSpec(_message.Message):
    __slots__ = ["launch_plan", "inputs", "metadata", "notifications", "disable_all", "labels", "annotations", "security_context", "auth_role", "quality_of_service", "max_parallelism", "raw_output_data_config", "cluster_assignment", "interruptible", "overwrite_cache", "envs", "task_node_runtime_overrides"]
    class TaskNodeRuntimeOverridesEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
        value: _workflow_pb2.TaskNodeOverrides
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[_workflow_pb2.TaskNodeOverrides, _Mapping]] = ...) -> None: ...
    ...
    TASK_NODE_RUNTIME_OVERRIDES_FIELD_NUMBER: _ClassVar[int]
