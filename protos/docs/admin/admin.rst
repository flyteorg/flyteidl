...
.. csv-table:: ExecutionSpec type fields
   ...
   "interruptible", ":ref:`ref_google.protobuf.BoolValue`", "", "Allows for the interruptible flag of a workflow to be overwritten for a single execution. Omitting this field uses the launch plan's value as a default. As we need to distinguish between the field not being provided and its default value "false", we have to use a wrapper around the bool field."
