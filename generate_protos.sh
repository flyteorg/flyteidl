...
docker run -v $DIR:/defs schottra/docker-protobufjs:latest --module-name flyteidl -d protos/flyteidl/core -d protos/flyteidl/admin -d protos/flyteidl/service -d protos/flyteidl/plugins -- --root flyteidl -t static-module -w es6 --no-delimited --force-long --no-convert -p /defs/protos
