...
_CONJUNCTIONEXPRESSION_LOGICALOPERATOR = _descriptor.EnumDescriptor(
  ...
  full_name='core.ConjunctionExpression.LogicalOperator',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_COMPARISONEXPRESSION = _descriptor.Descriptor(
  ...
  full_name='core.ComparisonExpression',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='operator', full_name='core.ComparisonExpression.operator', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='left_value', full_name='core.ComparisonExpression.left_value', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='right_value', full_name='core.ComparisonExpression.right_value', index=2,
...
_OPERAND = _descriptor.Descriptor(
  name='Operand',
  full_name='core.Operand',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='primitive', full_name='core.Operand.primitive', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='var', full_name='core.Operand.var', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='val', full_name='core.Operand.val',
...
_BOOLEANEXPRESSION = _descriptor.Descriptor(
  ...
  full_name='core.BooleanExpression',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='conjunction', full_name='core.BooleanExpression.conjunction', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='comparison', full_name='core.BooleanExpression.comparison', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='expr', full_name='core.BooleanExpression.expr',
      index=0, containing_type=None, fields=[]),
  ],
...
_CONJUNCTIONEXPRESSION = _descriptor.Descriptor(
  ...
  full_name='core.ConjunctionExpression',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='operator', full_name='core.ConjunctionExpression.operator', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='left_expression', full_name='core.ConjunctionExpression.left_expression', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='right_expression', full_name='core.ConjunctionExpression.right_expression', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OPERAND.fields_by_name['primitive'].message_type = core_dot_literals__pb2._PRIMITIVE
...
ComparisonExpression = _reflection.GeneratedProtocolMessageType('ComparisonExpression', (_message.Message,), dict(
  ...
  __module__ = 'core.condition_pb2'
  # @@protoc_insertion_point(class_scope:core.ComparisonExpression)
  ))
...
Operand = _reflection.GeneratedProtocolMessageType('Operand', (_message.Message,), dict(
  DESCRIPTOR = _OPERAND,
  __module__ = 'core.condition_pb2'
  # @@protoc_insertion_point(class_scope:core.Operand)
  ))
...
BooleanExpression = _reflection.GeneratedProtocolMessageType('BooleanExpression', (_message.Message,), dict(
  ...
  __module__ = 'core.condition_pb2'
  # @@protoc_insertion_point(class_scope:core.BooleanExpression)
  ))
...
ConjunctionExpression = _reflection.GeneratedProtocolMessageType('ConjunctionExpression', (_message.Message,), dict(
  ...
  __module__ = 'core.condition_pb2'
  # @@protoc_insertion_point(class_scope:core.ConjunctionExpression)
  ))
