...
AdminService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetProject_(AdminService_method_names[28], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  ...
  , rpcmethod_UpdateWorkflowAttributes_(AdminService_method_names[40], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetWorkflowAttributes_(AdminService_method_names[41], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteWorkflowAttributes_(AdminService_method_names[42], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListMatchableAttributes_(AdminService_method_names[43], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListNamedEntities_(AdminService_method_names[44], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNamedEntity_(AdminService_method_names[45], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateNamedEntity_(AdminService_method_names[46], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetVersion_(AdminService_method_names[47], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status AdminService::Stub::GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::flyteidl::admin::ProjectRegisterResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetProject_, context, request, response);
}

void AdminService::Stub::experimental_async::GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetProject_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::GetProject(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::ProjectRegisterResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetProject_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void AdminService::Stub::experimental_async::GetProject(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::ProjectRegisterResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetProject_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>* AdminService::Stub::AsyncGetProjectRaw(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::ProjectRegisterResponse>::Create(channel_.get(), cq, rpcmethod_GetProject_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>* AdminService::Stub::PrepareAsyncGetProjectRaw(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::ProjectRegisterResponse>::Create(channel_.get(), cq, rpcmethod_GetProject_, context, request, false);
}
...
AdminService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AdminService::Service, ::flyteidl::admin::GetProjectRequest, ::flyteidl::admin::ProjectRegisterResponse>(
...
::grpc::Status AdminService::Service::GetProject(::grpc::ServerContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
