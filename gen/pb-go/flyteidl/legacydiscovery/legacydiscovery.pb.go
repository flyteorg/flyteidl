...
// source: flyteidl/legacydiscovery/legacydiscovery.proto
...
func (QueryOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{0}
}
...
func (CreateResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{11, 0}
}
...
func (*Artifact) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{1}
}
...
func (*ArtifactId) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{2}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{3}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{4}
}
...
type IntFilter struct {
	...
	Operator             QueryOperator `protobuf:"varint,2,opt,name=operator,proto3,enum=pb.lyft.modeldiscovery.QueryOperator" json:"operator,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*IntFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{5}
}
...
func (*IntRangeFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{6}
}
...
func (*IntQueryKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{7}
}
...
func (*QueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{8}
}
...
func (*QueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{9}
}
...
func (*CreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{10}
}
...
type CreateResponse struct {
	Artifact             *Artifact             `protobuf:"bytes,1,opt,name=artifact,proto3" json:"artifact,omitempty"`
	Status               CreateResponse_Status `protobuf:"varint,2,opt,name=status,proto3,enum=pb.lyft.modeldiscovery.CreateResponse_Status" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*CreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{11}
}
...
func (*GenerateProvenanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{12}
}
...
func (*GenerateProvenanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacydiscovery_cf0326f67bc684a5, []int{13}
}
...
func init() {
	proto.RegisterType((*Parameter)(nil), "pb.lyft.modeldiscovery.Parameter")
	proto.RegisterType((*Artifact)(nil), "pb.lyft.modeldiscovery.Artifact")
	proto.RegisterType((*ArtifactId)(nil), "pb.lyft.modeldiscovery.ArtifactId")
	proto.RegisterType((*GetRequest)(nil), "pb.lyft.modeldiscovery.GetRequest")
	proto.RegisterType((*GetResponse)(nil), "pb.lyft.modeldiscovery.GetResponse")
	proto.RegisterType((*IntFilter)(nil), "pb.lyft.modeldiscovery.IntFilter")
	proto.RegisterType((*IntRangeFilter)(nil), "pb.lyft.modeldiscovery.IntRangeFilter")
	proto.RegisterType((*IntQueryKey)(nil), "pb.lyft.modeldiscovery.IntQueryKey")
	proto.RegisterType((*QueryRequest)(nil), "pb.lyft.modeldiscovery.QueryRequest")
	proto.RegisterType((*QueryResponse)(nil), "pb.lyft.modeldiscovery.QueryResponse")
	proto.RegisterType((*CreateRequest)(nil), "pb.lyft.modeldiscovery.CreateRequest")
	proto.RegisterType((*CreateResponse)(nil), "pb.lyft.modeldiscovery.CreateResponse")
	proto.RegisterType((*GenerateProvenanceRequest)(nil), "pb.lyft.modeldiscovery.GenerateProvenanceRequest")
	proto.RegisterType((*GenerateProvenanceResponse)(nil), "pb.lyft.modeldiscovery.GenerateProvenanceResponse")
	proto.RegisterEnum("pb.lyft.modeldiscovery.QueryOperator", QueryOperator_name, QueryOperator_value)
	proto.RegisterEnum("pb.lyft.modeldiscovery.CreateResponse_Status", CreateResponse_Status_name, CreateResponse_Status_value)
}
...
func (c *artifactsClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/pb.lyft.modeldiscovery.Artifacts/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artifactsClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.lyft.modeldiscovery.Artifacts/Query", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artifactsClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.lyft.modeldiscovery.Artifacts/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artifactsClient) GenerateProvenance(ctx context.Context, in *GenerateProvenanceRequest, opts ...grpc.CallOption) (*GenerateProvenanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.lyft.modeldiscovery.Artifacts/GenerateProvenance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Artifacts_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.lyft.modeldiscovery.Artifacts/Get",
	}
...
func _Artifacts_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.lyft.modeldiscovery.Artifacts/Query",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Artifacts_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.lyft.modeldiscovery.Artifacts/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Artifacts_GenerateProvenance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.lyft.modeldiscovery.Artifacts/GenerateProvenance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Artifacts_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.lyft.modeldiscovery.Artifacts",
	...
	Metadata: "flyteidl/legacydiscovery/legacydiscovery.proto",
}

func init() {
	proto.RegisterFile("flyteidl/legacydiscovery/legacydiscovery.proto", fileDescriptor_legacydiscovery_cf0326f67bc684a5)
}

var fileDescriptor_legacydiscovery_cf0326f67bc684a5 = []byte{
	// 801 bytes of a gzipped FileDescriptorProto
	,
}
