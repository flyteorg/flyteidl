...
const (
	ReservationStatus_SUCCESS ReservationStatus = 0
	ReservationStatus_FAILED  ReservationStatus = 1
)
...
func (SinglePropertyFilter_ComparisonOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_275951237ff4368a, []int{24, 0}
}
...
func (PaginationOptions_SortKey) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_275951237ff4368a, []int{30, 1}
}
...
func (m *GetOrReserveArtifactRequest) GetExpireAt() *timestamp.Timestamp {
	if m != nil {
		return m.ExpireAt
	}
	return nil
...
type GetOrReserveArtifactResponse struct {
	Artifact             *Artifact         `protobuf:"bytes,1,opt,name=artifact,proto3" json:"artifact,omitempty"`
	ReservationStatus    ReservationStatus `protobuf:"varint,2,opt,name=reservation_status,json=reservationStatus,proto3,enum=datacatalog.ReservationStatus" json:"reservation_status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *GetOrReserveArtifactResponse) GetReservationStatus() ReservationStatus {
	...
	return ReservationStatus_SUCCESS
}
...
func init() {
	proto.RegisterEnum("datacatalog.ReservationStatus", ReservationStatus_name, ReservationStatus_value)
...
var fileDescriptor_275951237ff4368a = []byte{
	...
	,
}
