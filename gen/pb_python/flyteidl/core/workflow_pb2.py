...
_WORKFLOWMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='interruptible', full_name='flyteidl.core.WorkflowMetadata.interruptible', index=0,
...
_NODEMETADATA.fields_by_name['interruptible'].message_type = flyteidl_dot_core_dot_literals__pb2._PRIMITIVE
