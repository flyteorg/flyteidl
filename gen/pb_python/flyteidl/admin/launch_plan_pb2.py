...
_LAUNCHPLANSPEC_OVERRIDESENTRY = _descriptor.Descriptor(
  name='OverridesEntry',
  full_name='flyteidl.admin.LaunchPlanSpec.OverridesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flyteidl.admin.LaunchPlanSpec.OverridesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='flyteidl.admin.LaunchPlanSpec.OverridesEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAUNCHPLANSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='overrides', full_name='flyteidl.admin.LaunchPlanSpec.overrides', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quality_of_service', full_name='flyteidl.admin.LaunchPlanSpec.quality_of_service', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='raw_output_data_config', full_name='flyteidl.admin.LaunchPlanSpec.raw_output_data_config', index=12,
  ...
  nested_types=[_LAUNCHPLANSPEC_OVERRIDESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_LAUNCHPLANSPEC_OVERRIDESENTRY.fields_by_name['value'].message_type = flyteidl_dot_admin_dot_common__pb2._OVERRIDEABLES
_LAUNCHPLANSPEC_OVERRIDESENTRY.containing_type = _LAUNCHPLANSPEC
...
_LAUNCHPLANSPEC.fields_by_name['overrides'].message_type = _LAUNCHPLANSPEC_OVERRIDESENTRY
...
LaunchPlanSpec = _reflection.GeneratedProtocolMessageType('LaunchPlanSpec', (_message.Message,), dict(
  ...
  OverridesEntry = _reflection.GeneratedProtocolMessageType('OverridesEntry', (_message.Message,), dict(
    DESCRIPTOR = _LAUNCHPLANSPEC_OVERRIDESENTRY,
    __module__ = 'flyteidl.admin.launch_plan_pb2'
    # @@protoc_insertion_point(class_scope:flyteidl.admin.LaunchPlanSpec.OverridesEntry)
    ))
  ,
...
_sym_db.RegisterMessage(LaunchPlanSpec.OverridesEntry)
...
_LAUNCHPLANSPEC_OVERRIDESENTRY._options = None
