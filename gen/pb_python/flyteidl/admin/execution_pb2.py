...
_EXECUTIONCLOSURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inputs_uri', full_name='flyteidl.admin.ExecutionClosure.inputs_uri', index=11,
