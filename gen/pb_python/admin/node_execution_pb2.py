...
_NODEEXECUTIONSTATUS.fields_by_name['phase'].enum_type = admin_dot_common__pb2._EXECUTIONPHASE
_NODEEXECUTIONSTATUS.fields_by_name['duration'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_NODEEXECUTIONRESULT.fields_by_name['outputs'].message_type = core_dot_interface__pb2._NAMEDVALUECOLLECTION
_NODEEXECUTIONRESULT.fields_by_name['error'].message_type = admin_dot_error__pb2._ERROR
...
_NODEEXECUTIONSPEC.fields_by_name['node'].message_type = core_dot_workflow__pb2._NODE
_NODEEXECUTIONSPEC.fields_by_name['inputs'].message_type = core_dot_interface__pb2._NAMEDVALUECOLLECTION
...
NodeExecutionEventRequest = _reflection.GeneratedProtocolMessageType('NodeExecutionEventRequest', (_message.Message,), dict(
  ...
  __module__ = 'admin.node_execution_pb2'
