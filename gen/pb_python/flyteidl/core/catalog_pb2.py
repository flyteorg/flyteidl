...
_CATALOGRESERVATIONSTATUS = _descriptor.EnumDescriptor(
  name='CatalogReservationStatus',
  full_name='flyteidl.core.CatalogReservationStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_CATALOGRESERVATIONSTATUS)

CatalogReservationStatus = enum_type_wrapper.EnumTypeWrapper(_CATALOGRESERVATIONSTATUS)
CACHE_DISABLED = 0
CACHE_MISS = 1
CACHE_HIT = 2
CACHE_POPULATED = 3
...
DESCRIPTOR.enum_types_by_name['CatalogReservationStatus'] = _CATALOGRESERVATIONSTATUS
