...
type GPUAccelerator struct {
	...
	Partition            isGPUAccelerator_Partition `protobuf_oneof:"partition"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
type isGPUAccelerator_Partition interface {
	isGPUAccelerator_Partition()
}
...
func (*GPUAccelerator_Unpartitioned) isGPUAccelerator_Partition() {}

func (*GPUAccelerator_PartitionSize) isGPUAccelerator_Partition() {}

func (m *GPUAccelerator) GetPartition() isGPUAccelerator_Partition {
	if m != nil {
		return m.Partition
	}
	return nil
...
func (m *GPUAccelerator) GetUnpartitioned() bool {
	if x, ok := m.GetPartition().(*GPUAccelerator_Unpartitioned); ok {
...
func (m *GPUAccelerator) GetPartitionSize() string {
	if x, ok := m.GetPartition().(*GPUAccelerator_PartitionSize); ok {
...
type ResourceMetadata struct {
	// Types that are valid to be assigned to Accelerator:
	//	*ResourceMetadata_GpuAccelerator
	Accelerator          isResourceMetadata_Accelerator `protobuf_oneof:"accelerator"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}
...
type isResourceMetadata_Accelerator interface {
	isResourceMetadata_Accelerator()
}
...
func (*ResourceMetadata_GpuAccelerator) isResourceMetadata_Accelerator() {}

func (m *ResourceMetadata) GetAccelerator() isResourceMetadata_Accelerator {
	if m != nil {
...
func (m *ResourceMetadata) GetGpuAccelerator() *GPUAccelerator {
	if x, ok := m.GetAccelerator().(*ResourceMetadata_GpuAccelerator); ok {
...
var fileDescriptor_bd8423ba58d6ed80 = []byte{
	...
	,
}
