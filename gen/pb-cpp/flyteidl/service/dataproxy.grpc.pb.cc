...
DataProxyService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_CreateUploadLocationBatch_(DataProxyService_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status DataProxyService::Stub::CreateUploadLocationBatch(::grpc::ClientContext* context, const ::flyteidl::service::CreateUploadLocationBatchRequest& request, ::flyteidl::service::CreateUploadLocationBatchResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_CreateUploadLocationBatch_, context, request, response);
}

void DataProxyService::Stub::experimental_async::CreateUploadLocationBatch(::grpc::ClientContext* context, const ::flyteidl::service::CreateUploadLocationBatchRequest* request, ::flyteidl::service::CreateUploadLocationBatchResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CreateUploadLocationBatch_, context, request, response, std::move(f));
}

void DataProxyService::Stub::experimental_async::CreateUploadLocationBatch(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::service::CreateUploadLocationBatchResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CreateUploadLocationBatch_, context, request, response, std::move(f));
}

void DataProxyService::Stub::experimental_async::CreateUploadLocationBatch(::grpc::ClientContext* context, const ::flyteidl::service::CreateUploadLocationBatchRequest* request, ::flyteidl::service::CreateUploadLocationBatchResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_CreateUploadLocationBatch_, context, request, response, reactor);
}

void DataProxyService::Stub::experimental_async::CreateUploadLocationBatch(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::service::CreateUploadLocationBatchResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_CreateUploadLocationBatch_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::service::CreateUploadLocationBatchResponse>* DataProxyService::Stub::AsyncCreateUploadLocationBatchRaw(::grpc::ClientContext* context, const ::flyteidl::service::CreateUploadLocationBatchRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::service::CreateUploadLocationBatchResponse>::Create(channel_.get(), cq, rpcmethod_CreateUploadLocationBatch_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::service::CreateUploadLocationBatchResponse>* DataProxyService::Stub::PrepareAsyncCreateUploadLocationBatchRaw(::grpc::ClientContext* context, const ::flyteidl::service::CreateUploadLocationBatchRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::service::CreateUploadLocationBatchResponse>::Create(channel_.get(), cq, rpcmethod_CreateUploadLocationBatch_, context, request, false);
}
...
DataProxyService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< DataProxyService::Service, ::flyteidl::service::CreateUploadLocationBatchRequest, ::flyteidl::service::CreateUploadLocationBatchResponse>(
          std::mem_fn(&DataProxyService::Service::CreateUploadLocationBatch), this)));
}
...
::grpc::Status DataProxyService::Service::CreateUploadLocationBatch(::grpc::ServerContext* context, const ::flyteidl::service::CreateUploadLocationBatchRequest* request, ::flyteidl::service::CreateUploadLocationBatchResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
