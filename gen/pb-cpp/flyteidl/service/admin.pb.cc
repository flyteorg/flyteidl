...
const char descriptor_table_protodef_flyteidl_2fservice_2fadmin_2eproto[] =
  ...
  "ty description.\022\233\003\n\027ListDescriptionEntit"
  "ies\022,.flyteidl.admin.DescriptionEntityLi"
  "stRequest\032%.flyteidl.admin.DescriptionEn"
  "tityList\"\252\002\202\323\344\223\002\331\001\022x/api/v1/description_"
  "entities/{description_entity_id.project}"
  "/{description_entity_id.domain}/{descrip"
  "tion_entity_id.name}Z]\022[/api/v1/descript"
  "ion_entities/{description_entity_id.proj"
  "ect}/{description_entity_id.domain}\222AG\032E"
  "Fetch existing description entity defini"
  "tions matching input filters.B9Z7github."
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fservice_2fadmin_2eproto = {
  ...
  "flyteidl/service/admin.proto", &assign_descriptors_table_flyteidl_2fservice_2fadmin_2eproto, 15456,
};
