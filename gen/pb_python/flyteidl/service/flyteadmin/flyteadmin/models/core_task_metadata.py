...
class CoreTaskMetadata(object):
    ...
    attribute_map = {
        ...
        'discovery_serializable': 'discovery_serializable'
    }

    def __init__(self, discoverable=None, runtime=None, timeout=None, retries=None, discovery_version=None, deprecated_error_message=None, interruptible=None, discovery_serializable=None):  # noqa: E501
        ...
        self._discovery_serializable = None
        ...
        if discovery_serializable is not None:
            self.discovery_serializable = discovery_serializable
    ...
    def discovery_serializable(self):
        """Gets the discovery_serializable of this CoreTaskMetadata.  # noqa: E501


        :return: The discovery_serializable of this CoreTaskMetadata.  # noqa: E501
        :rtype: bool
        """
        return self._discovery_serializable

    @discovery_serializable.setter
    def discovery_serializable(self, discovery_serializable):
        """Sets the discovery_serializable of this CoreTaskMetadata.


        :param discovery_serializable: The discovery_serializable of this CoreTaskMetadata.  # noqa: E501
        :type: bool
        """
