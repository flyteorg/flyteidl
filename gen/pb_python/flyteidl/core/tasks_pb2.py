...
_TASKMETADATA.fields_by_name['retries'].message_type = _RETRYSTRATEGY
...
_TASKTEMPLATE.fields_by_name['interface'].message_type = flyteidl_dot_core_dot_types__pb2._TYPEDINTERFACE
...
_CONTAINER.fields_by_name['env'].message_type = _KEYVALUEPAIR
_CONTAINER.fields_by_name['config'].message_type = _KEYVALUEPAIR
