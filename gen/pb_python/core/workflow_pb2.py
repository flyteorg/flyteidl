...
_WORKFLOWTEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='system_id', full_name='core.WorkflowTemplate.system_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IFELSEBLOCK.fields_by_name['error'].message_type = core_dot_types__pb2._ERROR
...
_WORKFLOWTEMPLATE.fields_by_name['interface'].message_type = core_dot_interface__pb2._TYPEDINTERFACE
_WORKFLOWTEMPLATE.fields_by_name['nodes'].message_type = _NODE
_WORKFLOWTEMPLATE.fields_by_name['outputs'].message_type = core_dot_literals__pb2._BINDING
