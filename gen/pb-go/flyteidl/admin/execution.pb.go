...
type ExecutionStatus_ExecutionState int32

const (
	// By default, all executions are considered active.
	ExecutionStatus_EXECUTION_ACTIVE ExecutionStatus_ExecutionState = 0
	// Archived executions are no longer visible in the UI.
	ExecutionStatus_EXECUTION_ARCHIVED ExecutionStatus_ExecutionState = 1
)

var ExecutionStatus_ExecutionState_name = map[int32]string{
	0: "EXECUTION_ACTIVE",
	1: "EXECUTION_ARCHIVED",
}

var ExecutionStatus_ExecutionState_value = map[string]int32{
	"EXECUTION_ACTIVE":   0,
	"EXECUTION_ARCHIVED": 1,
}

func (x ExecutionStatus_ExecutionState) String() string {
	return proto.EnumName(ExecutionStatus_ExecutionState_name, int32(x))
}

func (ExecutionStatus_ExecutionState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4e2785d91b3809ec, []int{19, 0}
}
...
type ExecutionClosure struct {
	...
	Status               *ExecutionStatus `protobuf:"bytes,14,opt,name=status,proto3" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ExecutionClosure) GetStatus() *ExecutionStatus {
	if m != nil {
		return m.Status
	}
	return nil
...
func (m *ExecutionUpdateRequest) GetStatus() *ExecutionStatus {
	if m != nil {
		return m.Status
	}
	return nil
...
type ExecutionStatus struct {
	State ExecutionStatus_ExecutionState `protobuf:"varint,1,opt,name=state,proto3,enum=flyteidl.admin.ExecutionStatus_ExecutionState" json:"state,omitempty"`
...
func (m *ExecutionStatus) GetState() ExecutionStatus_ExecutionState {
	if m != nil {
		return m.State
	}
	return ExecutionStatus_EXECUTION_ACTIVE
}

func (m *ExecutionStatus) GetOccurredAt() *timestamp.Timestamp {
	if m != nil {
		return m.OccurredAt
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("flyteidl.admin.ExecutionStatus_ExecutionState", ExecutionStatus_ExecutionState_name, ExecutionStatus_ExecutionState_value)
...
var fileDescriptor_4e2785d91b3809ec = []byte{
	...
	,
}
