...
class AdminServiceApi(object):
    ...
    def retrieve_and_lock_execution(self, body, **kwargs):  # noqa: E501
        """retrieve_and_lock_execution  # noqa: E501

        Retrieves an eligible Execution to be processed by FlytePropeller.  The execution will be locked and provides strong transactional semantics. Only one processor will get one execution. Routing rules are used to determine is eligible  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_and_lock_execution(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AdminRetrieveAndLockExecutionRequest body: (required)
        :return: AdminRetrieveAndLockExecutionResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.retrieve_and_lock_execution_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.retrieve_and_lock_execution_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def retrieve_and_lock_execution_with_http_info(self, body, **kwargs):  # noqa: E501
        """retrieve_and_lock_execution  # noqa: E501

        Retrieves an eligible Execution to be processed by FlytePropeller.  The execution will be locked and provides strong transactional semantics. Only one processor will get one execution. Routing rules are used to determine is eligible  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_and_lock_execution_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method retrieve_and_lock_execution" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `retrieve_and_lock_execution`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/executions/retrieve', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AdminRetrieveAndLockExecutionResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
