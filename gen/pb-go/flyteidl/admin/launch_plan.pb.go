...
type LaunchPlanSpec struct {
	...
	OutputDataPrefix     string   `protobuf:"bytes,17,opt,name=output_data_prefix,json=outputDataPrefix,proto3" json:"output_data_prefix,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LaunchPlanSpec) GetOutputDataPrefix() string {
	if m != nil {
		return m.OutputDataPrefix
	}
	return ""
}
...
var fileDescriptor_368a863574f5e699 = []byte{
	...
	,
}
