...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateLaunchPlanAttributes',
    full_name='flyteidl.service.AdminService.UpdateLaunchPlanAttributes',
    index=42,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_launch__plan__attributes__pb2._LAUNCHPLANATTRIBUTESUPDATEREQUEST,
    output_type=flyteidl_dot_admin_dot_launch__plan__attributes__pb2._LAUNCHPLANATTRIBUTESUPDATERESPONSE,
    serialized_options=_b('\202\323\344\223\002{\032v/api/v1/launch_plan_attributes/{attributes.project}/{attributes.domain}/{attributes.workflow}/{attributes.launch_plan}:\001*\222As\032qUpdate the customized resource attributes associated with a project, domain, workflow and launch plan combination'),
  ),
  _descriptor.MethodDescriptor(
    name='GetLaunchPlanAttributes',
    full_name='flyteidl.service.AdminService.GetLaunchPlanAttributes',
    index=43,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_launch__plan__attributes__pb2._LAUNCHPLANATTRIBUTESGETREQUEST,
    output_type=flyteidl_dot_admin_dot_launch__plan__attributes__pb2._LAUNCHPLANATTRIBUTESGETRESPONSE,
    serialized_options=_b('\202\323\344\223\002L\022J/api/v1/launch_plan_attributes/{project}/{domain}/{workflow}/{launch_plan}\222Au\032sRetrieve the customized resource attributes associated with a project, domain, workflow and launch plan combination'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteLaunchPlanAttributes',
    full_name='flyteidl.service.AdminService.DeleteLaunchPlanAttributes',
    index=44,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_launch__plan__attributes__pb2._LAUNCHPLANATTRIBUTESDELETEREQUEST,
    output_type=flyteidl_dot_admin_dot_launch__plan__attributes__pb2._LAUNCHPLANATTRIBUTESDELETERESPONSE,
    serialized_options=_b('\202\323\344\223\002O*J/api/v1/launch_plan_attributes/{project}/{domain}/{workflow}/{launch_plan}:\001*\222As\032qDelete the customized resource attributes associated with a project, domain, workflow and launch plan combination'),
  ),
  _descriptor.MethodDescriptor(
