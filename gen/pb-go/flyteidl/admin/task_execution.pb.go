...
type TaskExecutionClosure struct {
	...
	DeckUri              string   `protobuf:"bytes,18,opt,name=deck_uri,json=deckUri,proto3" json:"deck_uri,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TaskExecutionClosure) GetDeckUri() string {
	if m != nil {
		return m.DeckUri
	}
	return ""
...
var fileDescriptor_8cde4c3aa101642e = []byte{
	...
	,
}
