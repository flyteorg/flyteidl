...
_SQL_DIALECT = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='ANSI', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HIVE', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
