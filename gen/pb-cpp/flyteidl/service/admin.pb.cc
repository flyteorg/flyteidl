...
const char descriptor_table_protodef_flyteidl_2fservice_2fadmin_2eproto[] =
  ...
  "ed projects.\022\225\003\n\030RetrieveAndLockExecutio"
  "n\022/.flyteidl.admin.RetrieveAndLockExecut"
  "ionRequest\0320.flyteidl.admin.RetrieveAndL"
  "ockExecutionResponse\"\225\002\202\323\344\223\002 \"\033/api/v1/e"
  "xecutions/retrieve:\001*\222A\353\001\032\350\001Retrieves an"
  " eligible Execution to be processed by F"
  "lytePropeller.  The execution will be lo"
  "cked and provides strong transactional s"
  "emantics. Only one processor will get on"
  "e execution. Routing rules are used to d"
  "etermine is eligible\022\335\001\n\023CreateWorkflowE"
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fservice_2fadmin_2eproto = {
  ...
  "flyteidl/service/admin.proto", &assign_descriptors_table_flyteidl_2fservice_2fadmin_2eproto, 13273,
};
