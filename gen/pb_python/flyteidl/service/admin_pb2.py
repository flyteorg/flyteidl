...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListMatchableResources',
    full_name='flyteidl.service.AdminService.ListMatchableResources',
    index=39,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_matchable__resource__pb2._LISTMATCHABLERESOURCESREQUEST,
    output_type=flyteidl_dot_admin_dot_matchable__resource__pb2._LISTMATCHABLERESOURCESRESPONSE,
    serialized_options=_b('\202\323\344\223\002-\022+/api/v1/matchable_resources/{type}/{domain}\222A<\032:Retrieve a list of MatchableResourceConfiguration objects.'),
  ),
  _descriptor.MethodDescriptor(
