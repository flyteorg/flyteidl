...
class AdminServiceApi(object):
    ...
    def get_flyte_kit_metrics(self, id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs):  # noqa: E501
        """Fetches FlyteKit metrics for a :ref:`ref_flyteidl.admin.NodeExecution`.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flyte_kit_metrics(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_flyte_kit_metrics_with_http_info(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_flyte_kit_metrics_with_http_info(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs)  # noqa: E501
            return data

    def get_flyte_kit_metrics_with_http_info(self, id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, **kwargs):  # noqa: E501
        """Fetches FlyteKit metrics for a :ref:`ref_flyteidl.admin.NodeExecution`.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_flyte_kit_metrics_with_http_info(id_execution_id_project, id_execution_id_domain, id_execution_id_name, id_node_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_flyte_kit_metrics" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id_execution_id_project' not in params or
            ...
            raise ValueError("Missing the required parameter `id_execution_id_project` when calling `get_flyte_kit_metrics`")  # noqa: E501
        ...
        if ('id_execution_id_domain' not in params or
            ...
            raise ValueError("Missing the required parameter `id_execution_id_domain` when calling `get_flyte_kit_metrics`")  # noqa: E501
        ...
        if ('id_execution_id_name' not in params or
            ...
            raise ValueError("Missing the required parameter `id_execution_id_name` when calling `get_flyte_kit_metrics`")  # noqa: E501
        # verify the required parameter 'id_node_id' is set
        if ('id_node_id' not in params or
                params['id_node_id'] is None):
            raise ValueError("Missing the required parameter `id_node_id` when calling `get_flyte_kit_metrics`")  # noqa: E501
