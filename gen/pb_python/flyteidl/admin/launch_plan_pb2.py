...
from flyteidl.core import resource_pb2 as flyteidl_dot_core_dot_resource__pb2
...
_LAUNCHPLANSPEC_RESOURCESENTRY = _descriptor.Descriptor(
  name='ResourcesEntry',
  full_name='flyteidl.admin.LaunchPlanSpec.ResourcesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flyteidl.admin.LaunchPlanSpec.ResourcesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='flyteidl.admin.LaunchPlanSpec.ResourcesEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAUNCHPLANSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resources', full_name='flyteidl.admin.LaunchPlanSpec.resources', index=14,
  ...
  nested_types=[_LAUNCHPLANSPEC_RESOURCESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_LAUNCHPLANSPEC_RESOURCESENTRY.fields_by_name['value'].message_type = flyteidl_dot_core_dot_resource__pb2._RESOURCE
_LAUNCHPLANSPEC_RESOURCESENTRY.containing_type = _LAUNCHPLANSPEC
...
_LAUNCHPLANSPEC.fields_by_name['resources'].message_type = _LAUNCHPLANSPEC_RESOURCESENTRY
...
LaunchPlanSpec = _reflection.GeneratedProtocolMessageType('LaunchPlanSpec', (_message.Message,), dict(
  ...
  ResourcesEntry = _reflection.GeneratedProtocolMessageType('ResourcesEntry', (_message.Message,), dict(
    DESCRIPTOR = _LAUNCHPLANSPEC_RESOURCESENTRY,
    __module__ = 'flyteidl.admin.launch_plan_pb2'
    # @@protoc_insertion_point(class_scope:flyteidl.admin.LaunchPlanSpec.ResourcesEntry)
    ))
  ,
...
_sym_db.RegisterMessage(LaunchPlanSpec.ResourcesEntry)
...
_AUTH._options = None
_LAUNCHPLANSPEC_RESOURCESENTRY._options = None
