 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::flyteidl::admin::ProjectRegisterResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::ProjectRegisterResponse>> AsyncGetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::ProjectRegisterResponse>>(AsyncGetProjectRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::ProjectRegisterResponse>> PrepareAsyncGetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::ProjectRegisterResponse>>(PrepareAsyncGetProjectRaw(context, request, cq));
    }
    ...
    class experimental_async_interface {
     public:
      ...
      // Retrieve a :ref:`ref_flyteidl.admin.Project` with the Flyte deployment.
      virtual void GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetProject(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::ProjectRegisterResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      virtual void GetProject(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::ProjectRegisterResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      // Updates an existing :ref:`ref_flyteidl.admin.Project` 
      // flyteidl.admin.Project should be passed but the domains property should be empty;
      // it will be ignored in the handler as domains cannot be updated via this API.
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::ProjectRegisterResponse>* AsyncGetProjectRaw(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::flyteidl::admin::ProjectRegisterResponse>* PrepareAsyncGetProjectRaw(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::flyteidl::admin::ProjectRegisterResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>> AsyncGetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>>(AsyncGetProjectRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>> PrepareAsyncGetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>>(PrepareAsyncGetProjectRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      ...
      void GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response, std::function<void(::grpc::Status)>) override;
      void GetProject(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::ProjectRegisterResponse* response, std::function<void(::grpc::Status)>) override;
      void GetProject(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      void GetProject(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::ProjectRegisterResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>* AsyncGetProjectRaw(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::flyteidl::admin::ProjectRegisterResponse>* PrepareAsyncGetProjectRaw(::grpc::ClientContext* context, const ::flyteidl::admin::GetProjectRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // Retrieve a :ref:`ref_flyteidl.admin.Project` with the Flyte deployment.
    virtual ::grpc::Status GetProject(::grpc::ServerContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response);
    // Updates an existing :ref:`ref_flyteidl.admin.Project` 
    // flyteidl.admin.Project should be passed but the domains property should be empty;
    // it will be ignored in the handler as domains cannot be updated via this API.
  ...
  class WithAsyncMethod_GetProject : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetProject(::grpc::ServerContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetProject(::grpc::ServerContext* context, ::flyteidl::admin::GetProjectRequest* request, ::grpc::ServerAsyncResponseWriter< ::flyteidl::admin::ProjectRegisterResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    ExperimentalWithCallbackMethod_GetProject() {
      ::grpc::Service::experimental().MarkMethodCallback(28,
        new ::grpc::internal::CallbackUnaryHandler< ::flyteidl::admin::GetProjectRequest, ::flyteidl::admin::ProjectRegisterResponse>(
          [this](::grpc::ServerContext* context,
                 const ::flyteidl::admin::GetProjectRequest* request,
                 ::flyteidl::admin::ProjectRegisterResponse* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
    ...
    void SetMessageAllocatorFor_GetProject(
        ::grpc::experimental::MessageAllocator< ::flyteidl::admin::GetProjectRequest, ::flyteidl::admin::ProjectRegisterResponse>* allocator) {
      static_cast<::grpc::internal::CallbackUnaryHandler< ::flyteidl::admin::GetProjectRequest, ::flyteidl::admin::ProjectRegisterResponse>*>(
    ...
    virtual void GetProject(::grpc::ServerContext* context, const ::flyteidl::admin::GetProjectRequest* request, ::flyteidl::admin::ProjectRegisterResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_GetProject() {
      ::grpc::Service::MarkMethodStreamed(28,
        new ::grpc::internal::StreamedUnaryHandler< ::flyteidl::admin::GetProjectRequest, ::flyteidl::admin::ProjectRegisterResponse>(std::bind(&WithStreamedUnaryMethod_GetProject<BaseClass>::StreamedGetProject, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetProject(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::flyteidl::admin::GetProjectRequest,::flyteidl::admin::ProjectRegisterResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
