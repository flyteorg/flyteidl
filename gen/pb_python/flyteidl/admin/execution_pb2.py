...
_PLATFORMMETADATA = _descriptor.Descriptor(
  name='PlatformMetadata',
  full_name='flyteidl.admin.PlatformMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='execution_cluster', full_name='flyteidl.admin.PlatformMetadata.execution_cluster', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='platform_metadata', full_name='flyteidl.admin.ExecutionMetadata.platform_metadata', index=6,
...
_EXECUTIONMETADATA.fields_by_name['platform_metadata'].message_type = _PLATFORMMETADATA
...
DESCRIPTOR.message_types_by_name['PlatformMetadata'] = _PLATFORMMETADATA
...
PlatformMetadata = _reflection.GeneratedProtocolMessageType('PlatformMetadata', (_message.Message,), dict(
  DESCRIPTOR = _PLATFORMMETADATA,
  __module__ = 'flyteidl.admin.execution_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.admin.PlatformMetadata)
  ))
_sym_db.RegisterMessage(PlatformMetadata)
