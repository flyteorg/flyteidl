...
_LAUNCHPLANSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='envs', full_name='flyteidl.admin.LaunchPlanSpec.envs', index=15,
...
_LAUNCHPLANSPEC.fields_by_name['envs'].message_type = flyteidl_dot_admin_dot_common__pb2._ENVS
