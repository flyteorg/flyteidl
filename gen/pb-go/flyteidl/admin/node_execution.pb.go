...
func (*NodeExecutionIdentifier) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_0d6c3ce030889890, []int{0}
}
...
func (*NodeExecutionGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_0d6c3ce030889890, []int{1}
}
...
func (*NodeExecutionListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_0d6c3ce030889890, []int{2}
}
...
func (*NodeExecution) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_0d6c3ce030889890, []int{3}
}
...
func (*NodeExecutionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_0d6c3ce030889890, []int{4}
}
...
type NodeExecutionClosure struct {
	...
	//	*NodeExecutionClosure_TaskMetadata
	//	*NodeExecutionClosure_BranchMetadata
	//	*NodeExecutionClosure_WorkflowMetadata
	...
	Phase                core.NodeExecutionPhase             `protobuf:"varint,6,opt,name=phase,proto3,enum=flyteidl.core.NodeExecutionPhase" json:"phase,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                            `json:"-"`
	XXX_unrecognized     []byte                              `json:"-"`
	XXX_sizecache        int32                               `json:"-"`
}
...
func (*NodeExecutionClosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_0d6c3ce030889890, []int{5}
}
...
type NodeExecutionClosure_TaskMetadata struct {
	TaskMetadata *event.TaskNodeMetadata `protobuf:"bytes,1,opt,name=task_metadata,json=taskMetadata,proto3,oneof"`
}

type NodeExecutionClosure_BranchMetadata struct {
	BranchMetadata *event.BranchNodeMetadata `protobuf:"bytes,2,opt,name=branch_metadata,json=branchMetadata,proto3,oneof"`
}

type NodeExecutionClosure_WorkflowMetadata struct {
	WorkflowMetadata *event.SubworkflowNodeMetadata `protobuf:"bytes,3,opt,name=workflow_metadata,json=workflowMetadata,proto3,oneof"`
}

func (*NodeExecutionClosure_TaskMetadata) isNodeExecutionClosure_TargetMetadata() {}

func (*NodeExecutionClosure_BranchMetadata) isNodeExecutionClosure_TargetMetadata() {}

func (*NodeExecutionClosure_WorkflowMetadata) isNodeExecutionClosure_TargetMetadata() {}
...
func (m *NodeExecutionClosure) GetTaskMetadata() *event.TaskNodeMetadata {
	if x, ok := m.GetTargetMetadata().(*NodeExecutionClosure_TaskMetadata); ok {
		return x.TaskMetadata
	}
	return nil
}

func (m *NodeExecutionClosure) GetBranchMetadata() *event.BranchNodeMetadata {
	if x, ok := m.GetTargetMetadata().(*NodeExecutionClosure_BranchMetadata); ok {
		return x.BranchMetadata
	}
	return nil
}

func (m *NodeExecutionClosure) GetWorkflowMetadata() *event.SubworkflowNodeMetadata {
	if x, ok := m.GetTargetMetadata().(*NodeExecutionClosure_WorkflowMetadata); ok {
...
type NodeExecutionClosure_OutputUri struct {
	OutputUri string `protobuf:"bytes,4,opt,name=output_uri,json=outputUri,proto3,oneof"`
}

type NodeExecutionClosure_Error struct {
	Error *core.ExecutionError `protobuf:"bytes,5,opt,name=error,proto3,oneof"`
}
...
func (*NodeExecutionClosure) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _NodeExecutionClosure_OneofMarshaler, _NodeExecutionClosure_OneofUnmarshaler, _NodeExecutionClosure_OneofSizer, []interface{}{
		(*NodeExecutionClosure_TaskMetadata)(nil),
		(*NodeExecutionClosure_BranchMetadata)(nil),
		(*NodeExecutionClosure_WorkflowMetadata)(nil),
...
func _NodeExecutionClosure_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *NodeExecutionClosure_TaskMetadata:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.TaskMetadata); err != nil {
			return err
		}
	case *NodeExecutionClosure_BranchMetadata:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.BranchMetadata); err != nil {
			return err
		}
	case *NodeExecutionClosure_WorkflowMetadata:
...
func _NodeExecutionClosure_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*NodeExecutionClosure)
	switch tag {
	case 1: // target_metadata.task_metadata
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(event.TaskNodeMetadata)
		err := b.DecodeMessage(msg)
		m.TargetMetadata = &NodeExecutionClosure_TaskMetadata{msg}
		return true, err
	case 2: // target_metadata.branch_metadata
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(event.BranchNodeMetadata)
		err := b.DecodeMessage(msg)
		m.TargetMetadata = &NodeExecutionClosure_BranchMetadata{msg}
		return true, err
	case 3: // target_metadata.workflow_metadata
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(event.SubworkflowNodeMetadata)
		err := b.DecodeMessage(msg)
		m.TargetMetadata = &NodeExecutionClosure_WorkflowMetadata{msg}
		return true, err
	case 4: // output_result.output_uri
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
func init() {
	proto.RegisterFile("flyteidl/admin/node_execution.proto", fileDescriptor_node_execution_0d6c3ce030889890)
}

var fileDescriptor_node_execution_0d6c3ce030889890 = []byte{
	// 569 bytes of a gzipped FileDescriptorProto
	,
}
