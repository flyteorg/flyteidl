...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=26,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_project__pb2._PROJECTUPDATEREQUEST,
    output_type=flyteidl_dot_admin_dot_project__pb2._PROJECTUPDATERESPONSE,
    serialized_options=_b('\202\323\344\223\002\025\"\020/api/v1/projects:\001*\222A\023\032\021Update a project.'),
  ),
  _descriptor.MethodDescriptor(
    name='ListProjects',
