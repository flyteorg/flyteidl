...
const char descriptor_table_protodef_flyteidl_2fservice_2fadmin_2eproto[] =
  ...
  "Response\"r\202\323\344\223\002-\022+/api/v1/matchable_reso"
  "urces/{type}/{domain}\222A<\032:Retrieve a lis"
  "t of MatchableResourceConfiguration obje"
  "cts.\022\200\002\n\021ListNamedEntities\022&.flyteidl.ad"
  "min.NamedEntityListRequest\032\037.flyteidl.ad"
  "min.NamedEntityList\"\241\001\202\323\344\223\002;\0229/api/v1/na"
  "med_entities/{resource_type}/{project}/{"
  "domain}\222A]\032[Retrieve a list of NamedEnti"
  "ty objects sharing a common resource typ"
  "e, project, and domain.\022\312\001\n\016GetNamedEnti"
  "ty\022%.flyteidl.admin.NamedEntityGetReques"
  "t\032\033.flyteidl.admin.NamedEntity\"t\202\323\344\223\002K\022I"
  "/api/v1/named_entities/{resource_type}/{"
  "id.project}/{id.domain}/{id.name}\222A \032\036Re"
  "trieve a NamedEntity object.\022\363\001\n\021UpdateN"
  "amedEntity\022(.flyteidl.admin.NamedEntityU"
  "pdateRequest\032).flyteidl.admin.NamedEntit"
  "yUpdateResponse\"\210\001\202\323\344\223\002N\032I/api/v1/named_"
  "entities/{resource_type}/{id.project}/{i"
  "d.domain}/{id.name}:\001*\222A1\032/Update the fi"
  "elds associated with a NamedEntityB5Z3gi"
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fservice_2fadmin_2eproto = {
  ...
  "flyteidl/service/admin.proto", &assign_descriptors_table_flyteidl_2fservice_2fadmin_2eproto, 12737,
};
