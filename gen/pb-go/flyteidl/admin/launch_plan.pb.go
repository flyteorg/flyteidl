...
type LaunchPlanSpec struct {
	...
	Overrides map[string]*Overrideables `protobuf:"bytes,11,rep,name=overrides,proto3" json:"overrides,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *LaunchPlanSpec) GetOverrides() map[string]*Overrideables {
	if m != nil {
		return m.Overrides
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*Overrideables)(nil), "flyteidl.admin.LaunchPlanSpec.OverridesEntry")
...
var fileDescriptor_368a863574f5e699 = []byte{
	...
	,
}
