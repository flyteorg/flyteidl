...
extern PROTOBUF_INTERNAL_EXPORT_flyteidl_2fevent_2fevent_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_BatchedReason_flyteidl_2fevent_2fevent_2eproto;
...
class BatchedReasonDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<BatchedReason> _instance;
...
static void InitDefaultsBatchedReason_flyteidl_2fevent_2fevent_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::flyteidl::event::_BatchedReason_default_instance_;
    new (ptr) ::flyteidl::event::BatchedReason();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::flyteidl::event::BatchedReason::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<1> scc_info_BatchedReason_flyteidl_2fevent_2fevent_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsBatchedReason_flyteidl_2fevent_2fevent_2eproto}, {
      &scc_info_Timestamp_google_2fprotobuf_2ftimestamp_2eproto.base,}};
...
::google::protobuf::internal::SCCInfo<9> scc_info_TaskExecutionEvent_flyteidl_2fevent_2fevent_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 9, InitDefaultsTaskExecutionEvent_flyteidl_2fevent_2fevent_2eproto}, {
      ...
      &scc_info_BatchedReason_flyteidl_2fevent_2fevent_2eproto.base,
...
void InitDefaults_flyteidl_2fevent_2fevent_2eproto() {
  ...
  ::google::protobuf::internal::InitSCC(&scc_info_BatchedReason_flyteidl_2fevent_2fevent_2eproto.base);
...
const ::google::protobuf::uint32 TableStruct_flyteidl_2fevent_2fevent_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::flyteidl::event::BatchedReason, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::flyteidl::event::BatchedReason, reason_),
  PROTOBUF_FIELD_OFFSET(::flyteidl::event::BatchedReason, occurred_at_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 78, -1, sizeof(::flyteidl::event::BatchedReason)},
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&::flyteidl::event::_BatchedReason_default_instance_),
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fevent_2fevent_2eproto = {
  ...
  "flyteidl/event/event.proto", &assign_descriptors_table_flyteidl_2fevent_2fevent_2eproto, 3816,
};
...
void BatchedReason::InitAsDefaultInstance() {
  ::flyteidl::event::_BatchedReason_default_instance_._instance.get_mutable()->occurred_at_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
}
class BatchedReason::HasBitSetters {
 public:
  static const ::google::protobuf::Timestamp& occurred_at(const BatchedReason* msg);
};

const ::google::protobuf::Timestamp&
BatchedReason::HasBitSetters::occurred_at(const BatchedReason* msg) {
  return *msg->occurred_at_;
}
void BatchedReason::clear_occurred_at() {
  if (GetArenaNoVirtual() == nullptr && occurred_at_ != nullptr) {
    delete occurred_at_;
  }
  occurred_at_ = nullptr;
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int BatchedReason::kReasonFieldNumber;
const int BatchedReason::kOccurredAtFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

BatchedReason::BatchedReason()
  : ::google::protobuf::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:flyteidl.event.BatchedReason)
}
BatchedReason::BatchedReason(const BatchedReason& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:flyteidl.event.BatchedReason)
}

void BatchedReason::SharedCtor() {
  ::google::protobuf::internal::InitSCC(
      &scc_info_BatchedReason_flyteidl_2fevent_2fevent_2eproto.base);
  reason_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  occurred_at_ = nullptr;
...
BatchedReason::~BatchedReason() {
  // @@protoc_insertion_point(destructor:flyteidl.event.BatchedReason)
  SharedDtor();
}

void BatchedReason::SharedDtor() {
  reason_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (this != internal_default_instance()) delete occurred_at_;
}

void BatchedReason::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const BatchedReason& BatchedReason::default_instance() {
  ::google::protobuf::internal::InitSCC(&::scc_info_BatchedReason_flyteidl_2fevent_2fevent_2eproto.base);
  return *internal_default_instance();
}


void BatchedReason::Clear() {
// @@protoc_insertion_point(message_clear_start:flyteidl.event.BatchedReason)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* BatchedReason::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<BatchedReason*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("flyteidl.event.BatchedReason.reason");
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool BatchedReason::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:flyteidl.event.BatchedReason)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (10 & 0xFF)) {
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "flyteidl.event.BatchedReason.reason"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:flyteidl.event.BatchedReason)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:flyteidl.event.BatchedReason)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void BatchedReason::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:flyteidl.event.BatchedReason)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:flyteidl.event.BatchedReason)
}

::google::protobuf::uint8* BatchedReason::InternalSerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:flyteidl.event.BatchedReason)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:flyteidl.event.BatchedReason)
  return target;
}

size_t BatchedReason::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:flyteidl.event.BatchedReason)
  size_t total_size = 0;
...
void BatchedReason::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:flyteidl.event.BatchedReason)
  GOOGLE_DCHECK_NE(&from, this);
  const BatchedReason* source =
      ::google::protobuf::DynamicCastToGenerated<BatchedReason>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:flyteidl.event.BatchedReason)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:flyteidl.event.BatchedReason)
    MergeFrom(*source);
  }
}

void BatchedReason::MergeFrom(const BatchedReason& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:flyteidl.event.BatchedReason)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void BatchedReason::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:flyteidl.event.BatchedReason)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void BatchedReason::CopyFrom(const BatchedReason& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:flyteidl.event.BatchedReason)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool BatchedReason::IsInitialized() const {
  return true;
}

void BatchedReason::Swap(BatchedReason* other) {
  if (other == this) return;
  InternalSwap(other);
}
void BatchedReason::InternalSwap(BatchedReason* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::google::protobuf::Metadata BatchedReason::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_flyteidl_2fevent_2fevent_2eproto);
  return ::file_level_metadata_flyteidl_2fevent_2fevent_2eproto[kIndexInFileMessages];
}
    ...
    switch (tag >> 3) {
      ...
      case 21: {
        ...
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::flyteidl::event::BatchedReason::_InternalParse;
...
template<> PROTOBUF_NOINLINE ::flyteidl::event::BatchedReason* Arena::CreateMaybeMessage< ::flyteidl::event::BatchedReason >(Arena* arena) {
  return Arena::CreateInternal< ::flyteidl::event::BatchedReason >(arena);
}
