...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ADMINSERVICE.methods_by_name['GetNodeExecutionMetrics']._options = None
  _ADMINSERVICE.methods_by_name['GetNodeExecutionMetrics']._serialized_options = b'\202\323\344\223\002x\022v/api/v1/metrics/node_executions/{id.execution_id.project}/{id.execution_id.domain}/{id.execution_id.name}/{id.node_id}'
  _ADMINSERVICE._serialized_start=641
  _ADMINSERVICE._serialized_end=10882
