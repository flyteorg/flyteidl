...
type NodeExecutionClosure struct {
	...
	//	*NodeExecutionClosure_DynamicWorkflowNodeMetadata
...
type NodeExecutionClosure_DynamicWorkflowNodeMetadata struct {
	DynamicWorkflowNodeMetadata *DynamicWorkflowNodeMetadata `protobuf:"bytes,16,opt,name=dynamic_workflow_node_metadata,json=dynamicWorkflowNodeMetadata,proto3,oneof"`
}
...
func (*NodeExecutionClosure_DynamicWorkflowNodeMetadata) isNodeExecutionClosure_TargetMetadata() {}
...
func (m *NodeExecutionClosure) GetDynamicWorkflowNodeMetadata() *DynamicWorkflowNodeMetadata {
	if x, ok := m.GetTargetMetadata().(*NodeExecutionClosure_DynamicWorkflowNodeMetadata); ok {
...
func (*NodeExecutionClosure) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*NodeExecutionClosure_DynamicWorkflowNodeMetadata)(nil),
	}
}
...
var fileDescriptor_f73b3eae493fd736 = []byte{
	...
	,
}
