...
type LaunchPlanSpec struct {
	...
	QualityOfService     QualityOfService `protobuf:"varint,16,opt,name=quality_of_service,json=qualityOfService,proto3,enum=flyteidl.admin.QualityOfService" json:"quality_of_service,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *LaunchPlanSpec) GetQualityOfService() QualityOfService {
	if m != nil {
...
var fileDescriptor_368a863574f5e699 = []byte{
	...
	,
}
