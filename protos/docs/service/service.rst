...
.. csv-table:: AdminService service methods
   ...
   "UpdateLaunchPlanAttributes", ":ref:`ref_flyteidl.admin.LaunchPlanAttributesUpdateRequest`", ":ref:`ref_flyteidl.admin.LaunchPlanAttributesUpdateResponse`", "Creates or updates custom :ref:`ref_flyteidl.admin.MatchableAttributesConfiguration` for a project, domain and workflow."
   "GetLaunchPlanAttributes", ":ref:`ref_flyteidl.admin.LaunchPlanAttributesGetRequest`", ":ref:`ref_flyteidl.admin.LaunchPlanAttributesGetResponse`", "Fetches custom :ref:`ref_flyteidl.admin.MatchableAttributesConfiguration` for a project, domain and workflow."
   "DeleteLaunchPlanAttributes", ":ref:`ref_flyteidl.admin.LaunchPlanAttributesDeleteRequest`", ":ref:`ref_flyteidl.admin.LaunchPlanAttributesDeleteResponse`", "Deletes custom :ref:`ref_flyteidl.admin.MatchableAttributesConfiguration` for a project, domain and workflow."
