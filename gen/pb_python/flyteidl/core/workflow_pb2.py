...
_SIGNALCONDITIONAL = _descriptor.Descriptor(
  name='SignalConditional',
  full_name='flyteidl.core.SignalConditional',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_SLEEPCONDITIONAL = _descriptor.Descriptor(
  name='SleepConditional',
  full_name='flyteidl.core.SleepConditional',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='duration', full_name='flyteidl.core.SleepConditional.duration', index=0,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GATENODE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='signal', full_name='flyteidl.core.GateNode.signal', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sleep', full_name='flyteidl.core.GateNode.sleep', index=1,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='conditional', full_name='flyteidl.core.GateNode.conditional',
      index=0, containing_type=None, fields=[]),
  ],
...
_SLEEPCONDITIONAL.fields_by_name['duration'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_GATENODE.fields_by_name['signal'].message_type = _SIGNALCONDITIONAL
_GATENODE.fields_by_name['sleep'].message_type = _SLEEPCONDITIONAL
_GATENODE.oneofs_by_name['conditional'].fields.append(
  _GATENODE.fields_by_name['signal'])
_GATENODE.fields_by_name['signal'].containing_oneof = _GATENODE.oneofs_by_name['conditional']
_GATENODE.oneofs_by_name['conditional'].fields.append(
  _GATENODE.fields_by_name['sleep'])
_GATENODE.fields_by_name['sleep'].containing_oneof = _GATENODE.oneofs_by_name['conditional']
...
DESCRIPTOR.message_types_by_name['SignalConditional'] = _SIGNALCONDITIONAL
DESCRIPTOR.message_types_by_name['SleepConditional'] = _SLEEPCONDITIONAL
...
SignalConditional = _reflection.GeneratedProtocolMessageType('SignalConditional', (_message.Message,), dict(
  DESCRIPTOR = _SIGNALCONDITIONAL,
  __module__ = 'flyteidl.core.workflow_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.SignalConditional)
  ))
_sym_db.RegisterMessage(SignalConditional)

SleepConditional = _reflection.GeneratedProtocolMessageType('SleepConditional', (_message.Message,), dict(
  DESCRIPTOR = _SLEEPCONDITIONAL,
  __module__ = 'flyteidl.core.workflow_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.SleepConditional)
  ))
_sym_db.RegisterMessage(SleepConditional)
