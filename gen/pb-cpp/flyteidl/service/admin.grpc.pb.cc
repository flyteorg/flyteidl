...
AdminService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetDescriptionEntity_(AdminService_method_names[47], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListDescriptionEntities_(AdminService_method_names[48], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
