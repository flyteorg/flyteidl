...
from flyteidl.admin import quality_of_service_pb2 as flyteidl_dot_admin_dot_quality__of__service__pb2
...
_EXECUTIONSPEC.fields_by_name['quality_of_service'].message_type = flyteidl_dot_admin_dot_quality__of__service__pb2._QUALITYOFSERVICE
