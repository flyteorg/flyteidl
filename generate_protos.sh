...
SWAGGER_CLI_IMAGE="docker.io/lyft/swagger-codegen-cli:latest"
...
docker run --rm -v $DIR:/defs $SWAGGER_CLI_IMAGE generate -i /defs/gen/pb-go/flyteidl/service/admin.swagger.json -l go -o /defs/gen/pb-go/flyteidl/service/flyteadmin --additional-properties=packageName=flyteadmin

# # Generate Python API client code
docker run --rm -v $DIR:/defs $SWAGGER_CLI_IMAGE generate -i /defs/gen/pb-go/flyteidl/service/admin.swagger.json -l python -o /defs/gen/pb_python/flyteidl/service/flyteadmin --additional-properties=packageName=flyteadmin

# Remove documentation generated from the swagger-codegen-cli
sudo rm -rf gen/pb-go/flyteidl/service/flyteadmin/docs
sudo rm -rf gen/pb_python/flyteidl/service/flyteadmin/docs
