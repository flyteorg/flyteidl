...
// repeated string tags = 6;
inline int ExecutionCreateRequest::tags_size() const {
  return tags_.size();
}
inline void ExecutionCreateRequest::clear_tags() {
  tags_.Clear();
}
inline const ::std::string& ExecutionCreateRequest::tags(int index) const {
  // @@protoc_insertion_point(field_get:flyteidl.admin.ExecutionCreateRequest.tags)
  return tags_.Get(index);
}
inline ::std::string* ExecutionCreateRequest::mutable_tags(int index) {
  // @@protoc_insertion_point(field_mutable:flyteidl.admin.ExecutionCreateRequest.tags)
  return tags_.Mutable(index);
}
inline void ExecutionCreateRequest::set_tags(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:flyteidl.admin.ExecutionCreateRequest.tags)
  tags_.Mutable(index)->assign(value);
}
#if LANG_CXX11
inline void ExecutionCreateRequest::set_tags(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:flyteidl.admin.ExecutionCreateRequest.tags)
  tags_.Mutable(index)->assign(std::move(value));
}
#endif
inline void ExecutionCreateRequest::set_tags(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tags_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:flyteidl.admin.ExecutionCreateRequest.tags)
}
inline void ExecutionCreateRequest::set_tags(int index, const char* value, size_t size) {
  tags_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:flyteidl.admin.ExecutionCreateRequest.tags)
}
inline ::std::string* ExecutionCreateRequest::add_tags() {
  // @@protoc_insertion_point(field_add_mutable:flyteidl.admin.ExecutionCreateRequest.tags)
  return tags_.Add();
}
inline void ExecutionCreateRequest::add_tags(const ::std::string& value) {
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:flyteidl.admin.ExecutionCreateRequest.tags)
}
#if LANG_CXX11
inline void ExecutionCreateRequest::add_tags(::std::string&& value) {
  tags_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:flyteidl.admin.ExecutionCreateRequest.tags)
}
#endif
inline void ExecutionCreateRequest::add_tags(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:flyteidl.admin.ExecutionCreateRequest.tags)
}
inline void ExecutionCreateRequest::add_tags(const char* value, size_t size) {
  tags_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:flyteidl.admin.ExecutionCreateRequest.tags)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
ExecutionCreateRequest::tags() const {
  // @@protoc_insertion_point(field_list:flyteidl.admin.ExecutionCreateRequest.tags)
  return tags_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>*
ExecutionCreateRequest::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_list:flyteidl.admin.ExecutionCreateRequest.tags)
  return &tags_;
}
