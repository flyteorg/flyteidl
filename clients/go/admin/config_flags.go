...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "clientSecret"), defaultConfig.ClientSecret, "Client secret")
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "scopes"), []string{}, "List of scopes to request")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "issuerUrl"), defaultConfig.IssuerURL, "This is the URL to your IDP's authorization server'")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "tokenUrl"), defaultConfig.TokenURL, "Your IDP's token endpoint")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "grpcAuthorizationHeader"), defaultConfig.GrpcAuthorizationHeader, "Custom metadata header to pass JWT")
	return cmdFlags
}
