...
_NODEEXECUTIONEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_parent', full_name='flyteidl.event.NodeExecutionEvent.is_parent', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_dynamic', full_name='flyteidl.event.NodeExecutionEvent.is_dynamic', index=16,
