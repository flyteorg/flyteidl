...
func (ExecutionMetadata_ExecutionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{6, 0}
}
...
func (*ExecutionCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{0}
}
...
func (*ExecutionCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{1}
}
...
func (*Execution) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{2}
}
...
func (*ExecutionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{3}
}
...
func (*LiteralMapBlob) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{4}
}
...
func (*ExecutionClosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{5}
}
...
func (*ExecutionMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{6}
}
...
func (*ExecutionSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_execution_a18772e0b683f3fe, []int{7}
}
...
func init() {
	proto.RegisterFile("flyteidl/admin/execution.proto", fileDescriptor_execution_a18772e0b683f3fe)
}

var fileDescriptor_execution_a18772e0b683f3fe = []byte{
	// 660 bytes of a gzipped FileDescriptorProto
	,
}
