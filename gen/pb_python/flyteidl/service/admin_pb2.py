...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002L\022J/api/v1/entity_description/{id.project}/{id.domain}/{id.name}/{id.version}\222A*\032(Retrieve an existing entity description.'),
  ),
  _descriptor.MethodDescriptor(
