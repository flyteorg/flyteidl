...
_EXECUTIONCREATEREQUEST.fields_by_name['id'].message_type = admin_dot_common__pb2._IDENTIFIER
_EXECUTIONCREATEREQUEST.fields_by_name['spec'].message_type = _EXECUTIONSPEC
_EXECUTION.fields_by_name['id'].message_type = admin_dot_common__pb2._IDENTIFIER
...
_EXECUTIONSTATUS.fields_by_name['phase'].enum_type = admin_dot_common__pb2._EXECUTIONPHASE
_EXECUTIONRESULT.fields_by_name['outputs'].message_type = core_dot_interface__pb2._NAMEDVALUECOLLECTION
_EXECUTIONRESULT.fields_by_name['error'].message_type = admin_dot_error__pb2._ERROR
...
_EXECUTIONSPEC.fields_by_name['inputs'].message_type = core_dot_interface__pb2._NAMEDVALUECOLLECTION
_EXECUTIONSPEC.fields_by_name['metadata'].message_type = _EXECUTIONMETADATA
_EXECUTIONSPEC.fields_by_name['notifications'].message_type = admin_dot_common__pb2._NOTIFICATION
...
ExecutionCreateRequest = _reflection.GeneratedProtocolMessageType('ExecutionCreateRequest', (_message.Message,), dict(
  ...
  __module__ = 'admin.execution_pb2'
