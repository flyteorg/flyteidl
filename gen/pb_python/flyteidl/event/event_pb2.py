...
_MANAGEDRESOURCEINFO = _descriptor.Descriptor(
  name='ManagedResourceInfo',
  full_name='flyteidl.event.ManagedResourceInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='allocation_token', full_name='flyteidl.event.ManagedResourceInfo.allocation_token', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='namespace', full_name='flyteidl.event.ManagedResourceInfo.namespace', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TASKEXECUTIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='generated_name', full_name='flyteidl.event.TaskExecutionMetadata.generated_name', index=1,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='managed_resource_info', full_name='flyteidl.event.TaskExecutionMetadata.managed_resource_info', index=2,
...
_TASKEXECUTIONMETADATA.fields_by_name['managed_resource_info'].message_type = _MANAGEDRESOURCEINFO
...
DESCRIPTOR.message_types_by_name['ManagedResourceInfo'] = _MANAGEDRESOURCEINFO
...
ManagedResourceInfo = _reflection.GeneratedProtocolMessageType('ManagedResourceInfo', (_message.Message,), dict(
  DESCRIPTOR = _MANAGEDRESOURCEINFO,
  __module__ = 'flyteidl.event.event_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.event.ManagedResourceInfo)
  ))
_sym_db.RegisterMessage(ManagedResourceInfo)
