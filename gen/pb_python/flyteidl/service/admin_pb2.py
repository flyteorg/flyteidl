...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CreateDescriptionEntity',
    full_name='flyteidl.service.AdminService.CreateDescriptionEntity',
    index=47,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_description__entity__pb2._DESCRIPTIONENTITYCREATEREQUEST,
    output_type=flyteidl_dot_admin_dot_description__entity__pb2._DESCRIPTIONENTITYCREATERESPONSE,
    serialized_options=_b('\202\323\344\223\002!\"\034/api/v1/description_entities:\001*\222A\341\001\0324Create and register a description entity definition.JB\n\003400\022;\n9Returned for bad request that may have failed validation.Je\n\003409\022^\n\\Returned for a request that references an identical entity that has already been registered.'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002N\022L/api/v1/description_entities/{id.project}/{id.domain}/{id.name}/{id.version}\222A6\0324Retrieve an existing description entity description.'),
  ),
  _descriptor.MethodDescriptor(
    ...
    index=49,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_description__entity__pb2._DESCRIPTIONLISTREQUEST,
    output_type=flyteidl_dot_admin_dot_description__entity__pb2._DESCRIPTIONLIST,
    serialized_options=_b('\202\323\344\223\002\331\001\022x/api/v1/description_entities/{description_entity_id.project}/{description_entity_id.domain}/{description_entity_id.name}Z]\022[/api/v1/description_entities/{description_entity_id.project}/{description_entity_id.domain}\222AG\032EFetch existing description entity definitions matching input filters.'),
  ),
])
