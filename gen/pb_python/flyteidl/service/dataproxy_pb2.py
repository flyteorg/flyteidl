...
_DATAPROXYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002#\022\036/api/v1/dataproxy/artifact_urn:\001*\222AL\032JCreates a read-only http location that is accessible for tasks at runtime.'),
  ),
])
