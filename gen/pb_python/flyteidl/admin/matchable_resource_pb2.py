...
_WORKFLOWEXECUTIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='envs', full_name='flyteidl.admin.WorkflowExecutionConfig.envs', index=7,
...
_WORKFLOWEXECUTIONCONFIG.fields_by_name['envs'].message_type = flyteidl_dot_admin_dot_common__pb2._ENVS
