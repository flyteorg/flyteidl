...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=flyteidl_dot_admin_dot_execution__pb2._EXECUTIONCREATERESPONSE,
    serialized_options=_b('\202\323\344\223\002\037\"\032/api/v1/executions/recover:\001*\222AQ\032ORecovers a previously-run workflow execution that failed due to system failure.'),
  ),
  _descriptor.MethodDescriptor(
    name='GetExecution',
  ...
  _descriptor.MethodDescriptor(
    name='RecoverNodeExecution',
    full_name='flyteidl.service.AdminService.RecoverNodeExecution',
    index=23,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_node__execution__pb2._NODEEXECUTIONRECOVERREQUEST,
    output_type=flyteidl_dot_admin_dot_node__execution__pb2._NODEEXECUTIONRECOVERRESPONSE,
    serialized_options=_b('\202\323\344\223\002x\022v/api/v1/node_executions/recover/{id.execution_id.project}/{id.execution_id.domain}/{id.execution_id.name}/{id.node_id}\222AJ\032HRecovers already produced data from an existing node execution (if any).'),
  ),
  _descriptor.MethodDescriptor(
