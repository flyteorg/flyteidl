...
.. csv-table:: StructuredDatasetType type fields
   ...
   "partition_columns", ":ref:`ref_string`", "repeated", "This indicates which columns in the structured dataset is used for partitioning when the dataset is serialized. This is an optional field that will not be userd for type checking"
